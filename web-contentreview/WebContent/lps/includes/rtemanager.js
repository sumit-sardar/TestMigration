...
}};var djConfig={afterOnLoad:true,require:["dojo.parser","dijit.Editor","dijit.layout.ContentPane","dijit.layout.BorderContainer","dijit.form.Form","dijit._editor.range","dijit._editor.plugins.AlwaysShowToolbar","dijit._editor.plugins.LinkDialog","dijit._editor.plugins.Print","dijit._editor.plugins.TextColor","dijit._editor.plugins.FontChoice","dojox.editor.plugins.Smiley","dojox.editor.plugins.ToolbarLineBreak","dojox.editor.plugins.SafePaste","dojox.editor.plugins.NormalizeIndentOutdent"],debugAtAllCosts:false,addOnLoad:function(){
...
}};lz.rte.loader={__loading:false,__loaded:false,__callbacks:[],__dojoroot:"http://ajax.googleapis.com/ajax/libs/dojo/1.8.0/",__csspath:"dijit/themes/",__jspath:"dojo/dojo.js",loadDojoCSS:function($0,$1){
if($1!="(local)")lz.rte.util.loadCSS($0,lz.rte.loader.__dojoroot+lz.rte.loader.__csspath+$1+"/"+$1+".css");lz.rte.util.loadCSS($0,lz.rte.loader.__dojoroot+"/dojox/editor/plugins/resources/css/Smiley.css");lz.rte.util.loadCSS($0,lz.rte.loader.__dojoroot+"/dojox/editor/plugins/resources/css/SafePaste.css");if($1!="(local)")document.body.className+=document.body.className?" "+$1:$1
...
}}};lz.rte.manager={__id:null,__frameid:null,__loading:false,__loaded:false,__text:"",__onclick:null,__editing:false,__editor:null,button_counter:0,__theme:"tundra",__locale:null,__editor_class:null,__safepasting:false,__safepaste:{},FOCUS_KEYBOARD_PREV:-2,FOCUS_KEYBOARD:-1,FOCUS_MANUAL:0,FOCUS_MOUSE:1,__plugins:["undo","redo","|","cut","copy","paste","|","bold","italic","underline","strikethrough","|","insertOrderedList","insertUnorderedList","indent","outdent","|","justifyLeft","justifyRight","justifyCenter","justifyFull","|","foreColor","hiliteColor","|","createLink","unlink","insertImage","|","print","smiley","||","fontName","fontSize"],__focusonload:false,__extraplugins:[],create:function($0,$1){
lz.rte.manager.__id=$0;lz.rte.manager.__frameid=$1
},__destroy:function(){
...
var $2=lz.rte.manager.__plugins;var $3=lz.rte.manager.__extraplugins;$3.push("dijit._editor.plugins.AlwaysShowToolbar");$3.push("normalizeindentoutdent");if(lz.rte.manager.__safepasting){
var $4=lz.rte.manager.__safepaste;try{
var $5=eval("("+$4+")");$5["name"]="safepaste";$3.push($5)
}
catch($6){}};var $7=lz.rte.manager.__editor_class;try{
lz.rte.manager.__editor=new $7({height:"100%",focusOnLoad:lz.rte.manager.__focusonload,plugins:$2,extraPlugins:$3},$1);lz.rte.manager.__editor.onLoadDeferred.addCallback(lz.rte.manager.__rte_complete)
}
catch($6){}}},__rte_complete:function(){
...
var $1=lz.rte.manager.__frameid;if($1){
var $2=window.parent.document.getElementById($1);if($2)$2.focus();if(lz.rte.browser.browser=="Explorer"&&lz.rte.manager.__editor){
...
},addSafePaste:function($0){
lz.rte.manager.__safepasting=true;lz.rte.manager.__safepaste=$0
