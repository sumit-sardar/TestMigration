...
var $lzc$getFunctionDependencies = function ($0, $1, $2, $3, $4) {
    ...
    if (!(Function["$lzsc$isa"] ? Function.$lzsc$isa($6) : $6 instanceof Function)) {
...
(function () {
    var $0 = function ($0) {
        for (var $1 = $0.length - 1; $1 >= 1; $1 -= 2) {
            var $2 = $0[$1];
            var $3 = $0[$1 - 1];
            if ($2 !== void 0 || !($3 in this)) {
                this[$3] = $2
            };
            if (!($2 instanceof Function)) continue;
            var $4 = this.constructor;
            if ($2.hasOwnProperty("$superclasses")) {
                var $5 = $2.$superclasses,
                    $6 = false;
...
var Class = {
    ...
    make: function ($0, instanceProperties, $1, $2, $3) {
        switch (arguments.length) {
            case 1:
        ...
        if ($1 instanceof Array) {
            for (var $9 = $1.length - 1; $9 >= 0; $9--) {
                var $a = $1[$9];
                $8 = $a.makeInterstitial($8, $9 > 0 ? $1[$9 - 1] : $6)
            }
        };
        if ($3 instanceof Array) {
            for (var $9 = $3.length - 1; $9 >= 0; $9--) {
                var $a = $3[$9];
                $a.addImplementation($0, $6)
            }
        };
        $6.prototype = $8;
        this.addStaticProperty.call($6, "addStaticProperty", this.addStaticProperty);
        $6.addStaticProperty("addProperty", this.addProperty);
        $6.addStaticProperty("addProperties", this.addProperties);
        if ($2) {
            for (var $9 = $2.length - 1; $9 >= 1; $9 -= 2) {
                var $b = $2[$9];
                var $c = $2[$9 - 1];
                $6.addStaticProperty($c, $b)
            }
        };
        if (instanceProperties) {
            $6.addProperties(instanceProperties);
            if (lz.embed.browser.isSafari && lz.embed.browser.version == "531.21") {
                $6.addProperty("$lzsc$safarikludge", function () {
                    ...
                    for (var $0 = instanceProperties.length - 1; $0 >= 1; $0 -= 2) {
                        var $1 = instanceProperties[$0];
                        if (Function["$lzsc$isa"] ? Function.$lzsc$isa($1) : $1 instanceof Function) continue;
                        var $2 = instanceProperties[$0 - 1];
                        if ($1 !== void 0 || !($2 in this)) {
                            this[$2] = $1
                        }
                    }
                })
...
var Mixin = {
    prototype: new Instance(),
    allMixins: {},
    addProperty: function ($0, $1) {
        this.prototype[$0] = $1;
        this.instanceProperties.push($0, $1);
        var $2 = this.implementations;
        for (var $3 in $2) {
            var $4 = $2[$3];
            $4.addProperty($0, $1)
        }
    ...
    makeInterstitial: function ($0, $1) {
        var $2 = this.implementations;
        var $3 = this.classname + "+" + $0.constructor.classname;
        var $4 = $1.classname + "|" + $3;
        if ($2[$4]) {
            return $2[$4]
        };
        $0.addProperties(this.instanceProperties);
        var $5 = function () {
            this.constructor = arguments.callee
        };
        $5.prototype = $0;
    ...
    make: function ($0, $1, $2, $3, $4) {
        ...
        var $5 = {
            ...
            _dbg_name: $0,
            prototype: $2 ? $2.make() : new Object(),
            instanceProperties: $2 ? $2.instanceProperties.slice(0) : new Array(),
            implementations: {}
        };
        ...
        $5.addStaticProperty("addImplementation", this.addImplementation);
        $5.addStaticProperty("$lzsc$isa", this.$lzsc$isa);
        if ($3) {
...
Class.make("LzCache", ["size", void 0, "slots", void 0, "destroyable", void 0, "capacity", void 0, "curslot", void 0, "data", null, "$lzsc$initialize", function ($0, $1, $2) {
    ...
    if (++this.capacity > this.size) {
        var $0 = (this.curslot + 1) % this.slots;
        var $1 = this.data;
        if (this.destroyable) {
            var $2 = $1[$0];
            for (var $3 in $2) {
...
Class.make("LzBootstrapMessage", ["message", "", "length", 0, "$lzsc$initialize", function ($0) {
    ...
    var $0 = Array.prototype.slice.call(arguments, 0);
    var $1 = $0.length;
    for (var $2 = 0; $2 < $1; $2++) {
...
Mixin.make("LzFormatter", ["toNumber", function ($0) {
    ...
    var $2 = LzFormatter.singleEscapeCharacters;
    var $3 = '"';
    var $4 = "";
    var $5 = "'";
    if ($1) {
    ...
    var $1 = Array.prototype.slice.call(arguments, 1);
    var $2 = new LzMessage();
    if (!(typeof $0 == "string" || (String["$lzsc$isa"] ? String.$lzsc$isa($0) : $0 instanceof String)) || $1.length > 0 != $0.indexOf("%") >= 0) {
        $1 = [$0].concat($1);
    ...
    while ($9 < $8) {
        ...
        switch ($g) {
            ...
            case "G":
                $m = this.toNumber($m);
                $0.appendInternal(this.pad($m, $e, $n, $c, $b, $p, $o).toUpperCase(), $h, $j);
                $6($3++);
                break;
            case "c":
            ...
            case "s":
                ...
                $0.appendInternal(this.pad($s, $e, $n, $c, $b, $p, $o), $h, $j);
                $6($3++);
                break;
            case "d":
            case "u":
            ...
            case "g":
                $m = this.toNumber($m);
                $0.appendInternal(this.pad($m, $e, $n, $c, $b, $p, $o), $h, $j);
                $6($3++);
                break;
            case "%":
                $0.append("%");
...
Class.make("LzInitExpr", ["$lzsc$initialize", function () {}], LzValueExpr);
Class.make("LzOnceExpr", ["methodName", void 0, "$lzsc$initialize", function ($0, $1) {
    switch (arguments.length) {
        case 1:
            $1 = null;
...
Class.make("LzConstraintExpr", ["$lzsc$initialize", function ($0, $1) {
    switch (arguments.length) {
        case 1:
            $1 = null;
...
Class.make("LzStyleConstraintExpr", ["$lzsc$initialize", function ($0) {
    switch (arguments.length) {
        case 0:
            $0 = "=\"$style{'...'}\"";
...
Class.make("LzAlwaysExpr", ["dependenciesName", void 0, "$lzsc$initialize", function ($0, $1, $2) {
    switch (arguments.length) {
        case 2:
            $2 = null;

    };
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this, $0, $2);
    this.dependenciesName = $1
}], LzConstraintExpr);
Class.make("LzStyleExpr", ["$lzsc$initialize", function () {}], LzValueExpr);
Class.make("LzStyleAttr", ["sourceAttributeName", void 0, "$lzsc$initialize", function ($0) {
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this);
    this.sourceAttributeName = $0
}], LzStyleExpr);

function LzInheritedHash($0) {
    if ($0) {
        for (var $1 in $0) {
            this[$1] = $0[$1]
        }
...
Class.make("LzEventable", ["$lzsc$initialize", function () {}, "__LZdeleted", false, "_events", null, "__delegates", null, "ondestroy", LzDeclaredEvent, "destroy", function () {
    ...
    var $2 = "$lzc$set_" + $0;
    if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$2]) : this[$2] instanceof Function) {
        this[$2]($1)
    } else {
        this[$0] = $1;
        var $3 = this["on" + $0];
...
Class.make("LzStyleAttrBinder", ["target", void 0, "dest", void 0, "source", void 0, "$lzsc$initialize", function ($0, $1, $2) {
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this);
    this.target = $0;
    this.dest = $1;
    this.source = $2
...
Class.make("$lz$class_StringPresentationType", ["accept", function ($0, $1, $2) {
    return String($0)
...
Class.make("$lz$class_CDATAPresentationType", ["accept", function ($0, $1, $2) {
    var $3 = $lz$class_CDATAPresentationType.xmlEscapes;
    var $4 = "";
...
Class.make("$lz$class_BooleanPresentationType", ["accept", function ($0, $1, $2) {
...
Class.make("$lz$class_NumberPresentationType", ["accept", function ($0, $1, $2) {
    return Number($0)
...
Class.make("$lz$class_ColorPresentationType", ["accept", function ($0, $1, $2) {
    if ($0 == -1) {
        return null
    };
...
Class.make("$lz$class_ExpressionPresentationType", ["accept", function ($0, $1, $2) {
    switch ($0) {
        case "undefined":
            return void 0;
        case "null":
...
Class.make("$lz$class_SizePresentationType", ["accept", function ($0, $1, $2) {
    if ($0 == "null") {
        return null
    };
    return Number($0)
...
Class.make("$lz$class_CSSDeclarationPresentationType", ["PropRE", new RegExp("^\\s*(\\S*)\\s*:\\s*(\\S*)\\s*$"), "HyphenRE", new RegExp("-(\\w)", "g"), "CapitalRE", new RegExp("[A-Z]", "g"), "accept", function ($0, $1, $2) {
    var $3 = $0.split(";");
    var $4 = {};
...
Class.make("LzNode", ["__LZisnew", false, "__LZdeferredcarr", null, "classChildren", null, "animators", null, "__animatedAttributes", void 0, "_instanceAttrs", null, "_instanceChildren", null, "__LzValueExprs", null, "__LZhasConstraint", function ($0) {
    ...
    if (!(LzState["$lzsc$isa"] ? LzState.$lzsc$isa(this) : this instanceof LzState)) {
        for (var $8 in $7) {
            var $9 = $7[$8];
            if (!($9 && (LzInitExpr["$lzsc$isa"] ? LzInitExpr.$lzsc$isa($9) : $9 instanceof LzInitExpr))) {
                var $a = "$lzc$set_" + $8;
                if (!this[$a]) {
    ...
    if (Array["$lzsc$isa"] ? Array.$lzsc$isa($e) : $e instanceof Array) {
    ...
    for (var $8 in $7) {
        var $g = $7[$8];
        if (LzValueExpr["$lzsc$isa"] ? LzValueExpr.$lzsc$isa($g) : $g instanceof LzValueExpr) {
            $f[$8] = $g;
            delete $7[$8]
        }
    };
    ...
    for (var $7 = 0, $8 = $0.length; $7 < $8; $7++) {
        ...
        var $e = $2[$a];
        if (LzStyleExpr["$lzsc$isa"] ? LzStyleExpr.$lzsc$isa($e) : $e instanceof LzStyleExpr) {
    ...
    for (var $9 in $0) {
        ...
        $4[$9] = true;
        var $b = "$lzc$set_" + $9;
        if ($a && (LzInitExpr["$lzsc$isa"] ? LzInitExpr.$lzsc$isa($a) : $a instanceof LzInitExpr)) {
    ...
    if ("$delegates" in $0) {
        var $d = $0.$delegates;
        var $e = this.__LZconstraintdelegates;
        var $f;
    ...
    var $1 = this.__LZconstraintdelegates;
    if (!$1) {
    ...
    if ($1 && $1.length > 0) {
        var $2 = this.__LZconstraintdelegates;
        if (!$2) {
    ...
    var $1 = $0.methodName;
    if (!(Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$1]) : this[$1] instanceof Function)) {
        return
    };
    var $2 = null;
    if ($0 instanceof LzAlwaysExpr) {
        var $3 = $0;
        var $4 = $3.dependenciesName;
        if (!(Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$4]) : this[$4] instanceof Function)) {
            ...
            try {
                ...
                for (var $5 = 0, $6 = $2.length; $5 < $6; $5 += 2) {
                    var $7 = $2[$5];
                    if ($7 != null && !(LzEventable["$lzsc$isa"] ? LzEventable.$lzsc$isa($7) : $7 instanceof LzEventable)) {
                        $2[$5] = null
                    }
                }
            } catch ($8) {}
    ...
    if ($2) {
        for (var $3 = 0; $3 < $2.length;) {
            var $4 = $2[$3];
            if ((LzDelegate["$lzsc$isa"] ? LzDelegate.$lzsc$isa($4) : $4 instanceof LzDelegate) && $4.c === this && $4.m === this[$0]) {
    ...
    if (LzDataNodeMixin["$lzsc$isa"] ? LzDataNodeMixin.$lzsc$isa($0) : $0 instanceof LzDataNodeMixin) {
        var $1 = this.datapath || new LzDatapath(this);
        $1.setPointer($0)
    };
    ...
    if ($2 && this[$0] !== $1) {
        this.animate($0, $1, $2.duration, false, {
            motion: $2.motion
        })
    };
    return true
    ...
    for (var $3 in $0) {
        ...
        if ($4 === $2) {
            ...
            if (Object["$lzsc$isa"] ? Object.$lzsc$isa($4) : $4 instanceof Object) {
                var $5 = $1[$3];
                if (Object["$lzsc$isa"] ? Object.$lzsc$isa($5) : $5 instanceof Object) {
...
Class.make("$lzc$class_userClassPlacement", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 0:
            $0 = null;
        case 1:
...
Class.make("LzDelegate", ["__delegateID", 0, "__events", null, "$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    this.c = $0;
    var $4 = $0[$1];
    if (!(Function["$lzsc$isa"] ? Function.$lzsc$isa($4) : $4 instanceof Function)) {
        return
    };
    this.m = $4;
    if ($4.length != 1) {};
    ...
    var $4 = $0[$1];
    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($4) : $4 instanceof LzEvent) {
        $4.addDelegate(this)
    } else {
...
Class.make("LzEvent", ["delegateList", null, "$lzsc$initialize", function ($0, $1, $2) {
    switch (arguments.length) {
        case 2:
            $2 = null;
...
lz.Event = LzEvent;
Class.make("LzNotifyingEvent", ["$lzsc$initialize", function ($0, $1, $2) {
    switch (arguments.length) {
        case 2:
            $2 = null;
    ...
    var $1 = this.ready;
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["addDelegate"] || this.nextMethod(arguments.callee, "addDelegate")).call(this, $0);
    if (this.ready != $1) {
        this.notify(this.ready)
    }
}, "removeDelegate", function ($0) {
    ...
    var $1 = this.ready;
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["removeDelegate"] || this.nextMethod(arguments.callee, "removeDelegate")).call(this, $0);
    if (this.ready != $1) {
        this.notify(this.ready)
    }
}, "clearDelegates", function () {
...
}, "notify", function ($0) {}], LzEvent);
lz.NotifyingEvent = LzNotifyingEvent;
var LzResourceLibrary = {};
Class.make("LzKernelUtils", null, null, ["CSSDimension", function ($0, $1) {
    switch (arguments.length) {
        case 1:
            $1 = "px";
...
var LzIdleKernel = {
    ...
    __update: function () {
        var $0 = LzIdleKernel;
        var $1 = $0.__callbacks;
        var $2 = LzTimeKernel.getTimer();
        for (var $3 = $1.length - 2; $3 >= 0; $3 -= 2) {
            var $4 = $1[$3];
            var $5 = $1[$3 + 1];
            $4[$5]($2)
        }
    ...
    __intervalID: null,
    addCallback: function ($0, $1) {
        var $2 = LzIdleKernel;
        var $3 = $2.__callbacks;
        for (var $4 = $3.length - 2; $4 >= 0; $4 -= 2) {
            if ($3[$4] === $0 && $3[$4 + 1] == $1) {
                return
            }
        };
        ($2.__callbacks = $3.slice(0)).push($0, $1);
        if ($2.__intervalID == null) {
    ...
    removeCallback: function ($0, $1) {
        ...
        for (var $4 = $3.length - 2; $4 >= 0; $4 -= 2) {
            if ($3[$4] === $0 && $3[$4 + 1] == $1) {
                $2.__callbacks = $3 = $3.slice(0);
                var $5 = $3.splice($4, 2);
                if ($3.length == 0) {
                    clearInterval($2.__intervalID);
                    $2.__intervalID = null
                };
                return $5
            }
    ...
    setFrameRate: function ($0) {
        LzIdleKernel.__fps = $0;
        if (LzIdleKernel.__intervalID != null) {
            clearInterval(LzIdleKernel.__intervalID);
            LzIdleKernel.__intervalID = setInterval(LzIdleKernel.__update, 1000 / $0)
        }
    }
};
...
lz.BrowserUtils = {
    __scopeid: 0,
    __scopes: [],
    getcallbackstr: function ($0, $1) {
        var $2 = lz.BrowserUtils.__scopeid++;
        ...
        lz.BrowserUtils.__scopes[$2] = $0;
        return "if (lz.BrowserUtils.__scopes[" + $2 + "]) lz.BrowserUtils.__scopes[" + $2 + "]." + $1 + ".apply(lz.BrowserUtils.__scopes[" + $2 + "], [])"
    },
    getcallbackfunc: function ($0, name, args) {
        ...
        lz.BrowserUtils.__scopes[sc] = $0;
        return (function () {
            var $0 = lz.BrowserUtils.__scopes[sc];
            if ($0) return $0[name].apply($0, args)
        })
    },
    removecallback: function ($0) {
        if ($0.__callbacks != null) {
            for (var $1 in $0.__callbacks) {
                var $2 = $0.__callbacks[$1];
                delete lz.BrowserUtils.__scopes[$2]
            };
...
var LzPool = function ($0, $1, $2, $3) {
    this.cache = {};
    if (typeof $0 == "function") this.getter = $0;
    if (typeof $1 == "function") this.cacheHit = $1;
    if (typeof $2 == "function") this.destroyer = $2;
    if ($3) this.owner = $3
};
LzPool.prototype.cache = null;
LzPool.prototype.get = function ($0, $1) {
    var $2 = Array.prototype.slice.call(arguments, 2);
    var $3 = this.cache[$0];
    if ($1 || $3 == null) {
        $2.unshift($0);
        $3 = this.getter.apply(this, $2);
        if (!$1) this.cache[$0] = $3
    } else if (this.cacheHit) {
        $2.unshift($0, $3);
        this.cacheHit.apply(this, $2)
    };
    if (this.owner) $3.owner = this.owner;
    return $3
};
LzPool.prototype.flush = function ($0) {
    if (this.destroyer) this.destroyer($0, this.cache[$0]);
    delete this.cache[$0]
};
...
var LzKeyboardKernel = {
    ...
    __keyboardEvent: function ($0) {
        ...
        if ($3 >= 0 && $3 != 16 && $3 != 17 && $3 != 18 && $3 != 224) {
            var $6 = String.fromCharCode($3).toLowerCase();
            if ($4 == "keyup") {
                if ($5[$6] != null) {
                    $1[$6] = false;
                    $2 = true
        ...
        if ($2) {
            var $7 = LzKeyboardKernel.__scope;
            var $8 = LzKeyboardKernel.__callback;
            if ($7 && $7[$8]) {
                $7[$8]($1, $3, "on" + $4)
            }
        };
    ...
    __updateControlKeys: function ($0, $1) {
        var $2 = LzSprite.quirks;
        var $3 = LzKeyboardKernel.__downKeysHash;
        var $4 = false;
        if ($1) {
            var $5 = false
        } else {
        ...
        if ($4 && $5) {
            var $a = LzKeyboardKernel.__scope;
            var $b = LzKeyboardKernel.__callback;
            if ($a && $a[$b]) {
                $a[$b]($1, 0, "on" + $0.type)
            }
        };
    ...
    __allKeysUp: function () {
        ...
        var $5 = LzKeyboardKernel.__scope;
        var $6 = LzKeyboardKernel.__callback;
        if ($1 && $5 && $5[$6]) {
            if (!$2) {
                $5[$6]($0, 0, "onkeyup")
    ...
    setKeyboardControl: function ($0, $1) {
        ...
        var $2 = null;
        var $3 = LzSprite.__rootSprite.options.cancelkeyboardcontrol != true || true;
        if ($3 && $0) {
        ...
        var $5 = LzKeyboardKernel.__lastcontrolscope;
        if ($5 && $5 != $4) {
            $5.onkeydown = $5.onkeyup = $5.onkeypress = null;
            if ($2) {
    ...
    setGlobalFocusTrap: function ($0) {
        LzKeyboardKernel.__lockFocus = $0;
        if (LzSprite.quirks.activate_on_mouseover) {
            var $1 = LzSprite.__mouseActivationDiv;
            if ($0) {
                $1.onmouseover()
            } else {
                $1.onmouseout()
...
var LzMouseKernel = {
    ...
    __mouseEvent: function ($0) {
        $0 = $0 || window.event;
        var $1 = $0.target || $0.srcElement;
        var $2 = "on" + $0.type;
        ...
        var $3 = window["LzInputTextSprite"] && LzInputTextSprite.prototype;
        if ($3 && $3.__lastshown != null) {
        ...
        if ($2 === "onmousemove") {
            LzMouseKernel.__sendMouseMove($0);
            if ($3 && $3.__lastshown != null) {
    ...
    setMouseControl: function ($0) {
        if ($0 === LzMouseKernel.__mousecontrol) return;
        LzMouseKernel.__mousecontrol = $0;
        LzMouseKernel.__sendEvent($0 ? "onmouseenter" : "onmouseleave");
        var $1 = lz.embed[$0 ? "attachEventHandler" : "removeEventHandler"];
        if (LzSprite.prototype.capabilities.touchevents) {
    ...
    setCursorGlobal: function ($0) {
       ...
       /* LzSprite.prototype.__setCSSClassProperty(".lzdiv", "cursor", $0);
        ...
        if (LzSprite.quirks.fix_clickable) {
    ...
    setGlobalClickable: function ($0) {
        if ($0 === this.__globalClickable) return;
        this.__globalClickable = $0;
        var $1 = document.getElementById("lzcanvasclickdiv");
        if (LzSprite.quirks.fix_ie_clickable) {
    ...
    __sendMouseMove: function ($0, $1, $2) {
        var $3 = "mousemove" === $0.type;
        var $4 = true;
        if (LzSprite.prototype.capabilities.touchevents) {
            var $5 = $0.touches;
            var $6 = $5 && $5[0];
            if ($6) {
                LzMouseKernel.__x = $6.pageX;
                LzMouseKernel.__y = $6.pageY
            };
            $3 = true;
            $4 = false
        } else if ($0.pageX || $0.pageY) {
            LzMouseKernel.__x = $0.pageX;
            LzMouseKernel.__y = $0.pageY
        } else if ($0.clientX || $0.clientY) {
            var $7 = document.body,
                $8 = document.documentElement;
            LzMouseKernel.__x = $0.clientX + $7.scrollLeft + $8.scrollLeft;
            LzMouseKernel.__y = $0.clientY + $7.scrollTop + $8.scrollTop
        };
        if ($1) {
            LzMouseKernel.__x += $1
        };
    ...
    __handleContextMenu: function ($0) {
        LzMouseKernel.__sendMouseMove($0);
        var $1 = $0.target || $0.srcElement;
        if ($1 instanceof HTMLInputElement || $1 instanceof HTMLTextAreaElement) {
            return true
        };
        var $2 = LzMouseKernel.__findContextMenu($0);
        if ($2) {
            var $3 = "on" + $0.type;
            var $4 = $2.kernel.showbuiltins;
            var $5 = false;
            ...
            var $1 = $0.target || $0.srcElement;
            if ($1 && $1.owner && $4 !== true) {
                LzMouseKernel.__contextmenumouse2 = $5;
                if (LzMouseKernel.__showncontextmenu) {
                    LzContextMenuKernel.lzcontextmenu.hide()
                } else {
                    var $6 = $1.owner instanceof LzSprite ? $1.owner.owner : null;
                    $2.kernel.__show($6)
                };
                return false
            }
    ...
    __findContextMenu: function ($0) {
        var $1 = LzSprite.__rootSprite.__contextmenu;
        var $2 = LzSprite.quirks;
        if (document.elementFromPoint) {
            if (window.pageXOffset) {
                var $3 = $0.pageX - window.top.pageXOffset;
                var $4 = $0.pageY - window.top.pageYOffset
            } else {
                var $3 = $0.clientX;
                var $4 = $0.clientY
            };
            var $5 = LzSprite.__rootSprite.__LZdiv;
            var $6 = ($0.srcElement || $0.target).owner;
            var $7 = [];
            if ($2.fix_contextmenu) {
                $7.push($5, $5.style.display);
                var $8 = $5.style.zIndex;
                $5.style.zIndex = -1000;
                var $9;
                if ($2.fix_clickable) {
                    $9 = LzSprite.__rootSprite.__LZclickcontainerdiv;
                    var $a = $9.style.zIndex;
                    $7.push($9, $9.style.display);
                    $9.style.zIndex = -9999
                }
            };
            do {
                var $b = document.elementFromPoint($3, $4);
                if (!$b) {
                    break
                } else {
                    var $c = $b.owner;
                    ...
                    $7.push($b, $b.style.display);
                    $b.style.display = "none"
                }
            } while ($b !== $5 && $b.tagName != "HTML");
            for (var $d = $7.length - 1; $d >= 0; $d -= 2) {
            ...
            var $e = ($0.srcElement || $0.target).owner;
            if ($e) {
                while ($e.__parent) {
                    if ($e.__contextmenu) {
                        var $f = $e.getMouse();
                        if ($f.x >= 0 && $f.x < $e.width && $f.y >= 0 && $f.y < $e.height) {
                            $1 = $e.__contextmenu;
                            break
                        }
                    };
...
Class.make("LzBrowserKernel", null, null, ["loadURL", function ($0, $1, $2) {
    ...
    var $5 = Array.prototype.slice.call(arguments, 2);
    if ($3) {
        var $6 = $3.apply($2, $5)
    };
    if ($1 && typeof $1 == "function") $1($6);
    return $6
    ...
    if (!$0) $0 = new String(window.location);
    var $1 = $0.indexOf(":");
    var $2 = $0.indexOf("/");
    if ($1 > -1) {
        if ($0.indexOf("://") == $1) {
            ...
            $0 = $0.substring(0, $1 + 1) + "/" + $0.substring($1 + 1);
            return $0
        } else {
            var $3 = new LzURL(new String(window.location));
            $0 = $0.substring(0, $1 + 1) + "/" + $3.path + $0.substring($1 + 1);
            return $0
        }
    } else {
        if ($2 == 0) {
            ...
            var $4 = new String(window.location);
            var $5 = $4.lastIndexOf("/");
            $4 = $4.substring(0, $5 + 1);
            return $4 + $0
        }
    ...
    var $1 = global;
    var $2 = LzSprite.__rootSprite._id;
    if ($2) {
...
LzSprite.prototype.__setupRoot = function ($0) {
    var $1 = this.quirks;
    this.isroot = true;
    LzSprite.__rootSprite = this;
    var $2 = document.createElement("div");
    $2.className = "lzcanvasdiv";
    $1["scrollbar_width"] = LzSprite._getScrollbarWidth();
    if ($1.ie6_improve_memory_performance) {
        try {
            document.execCommand("BackgroundImageCache", false, true)
        } catch ($3) {}
    };
    var $4 = lz.embed.__propcache;
    var $5 = LzSprite.__rootSpriteContainer = $4.appenddiv;
    var $6 = $5;
    $5.style.margin = 0;
    $5.style.padding = 0;
    $5.style.border = "0 none";
    $5.style.overflow = "hidden";
    $5.style.textAlign = "left";
    if ($1["container_divs_require_overflow"]) {
        $6 = document.createElement("div");
        $6.className = "lzappoverflow";
        $5.appendChild($6);
        $6.owner = this;
        if ($1["fix_div_mouse_scrolling"]) {
            $6.addEventListener("scroll", function ($0) {
                if ($0 && $0.target && $0.target.className && $0.target.className == "lzappoverflow") {
                    $0.target.scrollTop = 0;
                    $0.target.scrollLeft = 0
                }
            }, true)
        };
    ...
    if ($1.fix_contextmenu) {
        ...
        $7.className = "lzcanvascontextdiv";
        $7.id = "lzcanvascontextdiv";
        $6.appendChild($7);
        $7.owner = this;
        this.__LZcontextcontainerdiv = $7
    };
    if ($4.bgcolor) {
        $2.style.backgroundColor = $4.bgcolor;
    ...
    LzSprite.blankimage = $8.serverroot + LzSprite.blankimage;
    if ($1.use_css_sprites && $8.usemastersprite) {
        $1.use_css_master_sprite = $8.usemastersprite;
        var $9 = LzResourceLibrary && LzResourceLibrary.__allcss && LzResourceLibrary.__allcss.path;
        if ($9) {
            LzSprite.__masterspriteurl = LzSprite.__rootSprite.options.approot + $9
        }
    };
    LzSprite.__defaultStyles.writeCSS($1.write_css_with_createstylesheet);
    $6.appendChild($2);
    this.__LZdiv = $2;
    if ($1.fix_clickable) {
        var $a = document.createElement("div");
        $a.className = "lzcanvasclickdiv";
        $a.id = "lzcanvasclickdiv";
        $6.appendChild($a);
        $a.owner = this;
        this.__LZclickcontainerdiv = $a;
        LzSprite.__setClickable(true, $a)
    } else {
        LzSprite.__setClickable(true, $2);
        LzSprite.__setActivateOnMouseoverForNoClickDiv($2)
    };
    if ($1["css_hide_canvas_during_init"]) {
        ...
        this.__LZdiv.style[$b] = $c;
        if ($1["fix_clickable"]) this.__LZclickcontainerdiv.style[$b] = $c;
        if ($1["fix_contextmenu"]) this.__LZcontextcontainerdiv.style[$b] = $c
    };
    if ($1.fix_clickable) {
...
LzSprite.__setActivateOnMouseover = function (div) {
    ...
    div.onmouseout = function ($0) {
        ...
        var $4 = $1.owner;
        if ($1) {
            var $5 = LzContextMenuKernel.lzcontextmenu;
            if ($4 && $1.className.indexOf("lz") == 0) {
                $3 = true
        ...
        if ($3) {
            var $6 = LzMouseKernel.__globalClickable;
            if ($2.fix_ie_clickable) {
            ...
            this.mouseisover = true;
            if ($2.fix_clickable && !$6 && LzMouseKernel.__globalClickable) {
                if ($4) {
...
LzSprite.__defaultStyles = {
    ...
    writeCSS: function ($0) {
        ...
        var $2 = "";
        for (var $3 in this) {
            if ($3 == "writeCSS" || $3 == "hyphenate" || $3 == "__replace" || $3 == "__re") continue;
            $2 += $3.indexOf("#") == -1 ? "." : "";
            $2 += $3 + "{";
            for (var $4 in this[$3]) {
                var $5 = this[$3][$4];
                $2 += this.hyphenate($4) + ":" + $5 + ";"
            };
            $2 += "}"
        };
        $2 += LzFontManager.generateCSS();
        if ($0) {
            if (!document.styleSheets["lzstyles"]) {
                var $6 = document.createStyleSheet();
                $6.owningElement.id = "lzstyles";
                $6.cssText = $2
            }
        } else {
            var $7 = document.createElement("style");
            $7.setAttribute("type", "text/css");
            $7.appendChild(document.createTextNode($2));
            document.getElementsByTagName("head")[0].appendChild($7)
        }
    },
    __re: new RegExp("[A-Z]", "g"),
    hyphenate: function ($0) {
...
LzSprite.prototype.__copystyles = function ($0, $1) {
    ...
    var $5 = $2.__csscache.__LZdivdisplay || "";
    if ($5) {
        $1.style.display = $5
    };
    $1.style.zIndex = $2._z || $0.style.zIndex;
    if ($2._transform) {
        var $6 = LzSprite.__styleNames.transform;
        $1.style[$6] = $2._transform
    }
};
LzSprite.prototype.__csscache;
LzSprite.prototype.setCSS = function ($0, $1, $2) {
    if ($2) $1 = this.CSSDimension($1);
    var $3 = this["set_" + $0];
    if ($3) {
        $3.call(this, $1)
    } else {
...
LzSprite.__updateQuirks = function () {
    var $0 = LzSprite.quirks;
    var $1 = LzSprite.prototype.capabilities;
    var $2 = LzSprite.__styleNames;
    var $3 = LzSprite.__defaultStyles;
    if (window["lz"] && lz.embed && lz.embed.browser) {
        var $4 = lz.embed.browser;
	/* change for desktop LDB */
		if($4.browser == "Mozilla") {
			$4.isSafari = true;
			$4.version = 525;
		}
		/* end of change for desktop LDB */
        if ($4.isIE) {
            if ($4.version < 7) {
                $0["ie_alpha_image_loader"] = true;
                $0["document_size_compute_correct_height"] = true;
                $0["ie6_improve_memory_performance"] = true
            } else {
                $0["prevent_selection"] = true;
                $0["invisible_parent_image_sizing_fix"] = true;
                if ($4.osversion >= 6 && $4.version < 9) {
                    $0["ie_alpha_image_loader"] = true
                };
                if ($4.version == 8) {
            ...
            $0["fix_ie_divheight_change"] = true;
            if ($4.version >= 9) {
                $0["fix_ie9_textwidth"] = true;
                $1["cornerradius"] = true;
                $1["rotation"] = true;
                $2.transform = "MsTransform";
                $2.transformOrigin = "MsTransformOrigin"
            };
            if ($4.version <= 8) {
                $0["ie_opacity"] = true
            };
            $0["ie_timer_closure"] = true;
            $0["ie_leak_prevention"] = true;
            $0["fix_ie_clickable"] = true;
            $0["fix_ie_background_height"] = true;
            $0["inner_html_no_entity_apos"] = true;
            $1["minimize_opacity_changes"] = true;
            $0["set_height_for_multiline_inputtext"] = true;
            $0["text_measurement_use_insertadjacenthtml"] = true;
            $0["text_content_use_inner_text"] = true;
            $0["text_selection_use_range"] = true;
            $0["text_ie_carriagereturn"] = true;
            $0["ie_paste_event"] = true;
            $0["keypress_function_keys"] = false;
            $0["text_event_charcode"] = false;
            $0["ie_mouse_events"] = true;
            $0["inputtext_size_includes_margin"] = true;
            $0["focus_on_mouseover"] = false;
            $0["textstyle_on_textdiv"] = true;
            $0["use_css_sprites"] = !$0["ie_alpha_image_loader"];
            $0["textgrabsinputtextfocus"] = true;
            $0["ie_elementfrompoint"] = true;
            $0["fix_ie_css_syntax"] = true;
            $0["write_css_with_createstylesheet"] = true;
            $0["hasmetakey"] = false;
            $0["inputtext_use_background_image"] = true;
            $0["show_img_before_changing_size"] = true;
            $0["use_filter_for_dropshadow"] = true;
            $3["lzswfinputtext"].resize = "none";
            $3["lzswfinputtextmultiline"].resize = "none";
            $1["dropshadows"] = true;
            $3["#lzTextSizeCache"].zoom = 1;
            $3["#lzTextSizeCache"].position = "relative";
            $0["prevent_selection_with_onselectstart"] = true
        } else if ($4.isSafari || $4.isChrome) {
            $2.borderRadius = "WebkitBorderRadius";
            $2.borderTopLeftRadius = "WebkitBorderTopLeftRadius";
            $2.borderTopRightRadius = "WebkitBorderTopRightRadius";
            $2.borderBottomRightRadius = "WebkitBorderBottomRightRadius";
            $2.borderBottomLeftRadius = "WebkitBorderBottomLeftRadius";
            $2.boxShadow = "WebkitBoxShadow";
            $2.userSelect = "WebkitUserSelect";
            $2.transform = "WebkitTransform";
            $2.transformOrigin = "WebkitTransformOrigin";
            $0["safari_visibility_instead_of_display"] = true;
            $0["absolute_position_accounts_for_offset"] = true;
            if ($4.version < 525.18) {
                $0["canvas_div_cannot_be_clipped"] = true;
                $0["invisible_parent_image_sizing_fix"] = true;
                $0["safari_textarea_subtract_scrollbar_height"] = true
            };
            $0["document_size_use_offsetheight"] = true;
            if ($4.version > 523.1) {
                $1["rotation"] = true;
                $1["scaling"] = true;
                $1["dropshadows"] = true;
                $1["cornerradius"] = true;
                $0["explicitly_set_border_radius"] = true;
                $1["rgba"] = true
            };
            $0["safari_paste_event"] = true;
            $0["keypress_function_keys"] = false;
            if ($4.version < 523.15) {
            ...
            if ($4.isIphone) {
                $0["canvas_div_cannot_be_clipped"] = true;
                $1["touchevents"] = true;
                $1["screenorientation"] = true
            };
            $0["inputtext_strips_newlines"] = true;
            $0["prevent_selection"] = true;
            $0["container_divs_require_overflow"] = true;
            $0["fix_div_mouse_scrolling"] = true;
            $3.lzswfinputtext.paddingTop = "0px";
            $3.lzswfinputtext.paddingBottom = "2px";
            $3.lzswfinputtext.paddingLeft = "1px";
            $3.lzswfinputtext.paddingRight = "3px";
            $3.lzswfinputtextmultiline.paddingTop = "2px";
            $3.lzswfinputtextmultiline.paddingBottom = "2px";
            $3.lzswfinputtextmultiline.paddingLeft = "2px";
            $3.lzswfinputtextmultiline.paddingRight = "2px"
        } else if ($4.isOpera) {
            $2.transform = "OTransform";
            $2.transformOrigin = "OTransformOrigin";
            $0["invisible_parent_image_sizing_fix"] = true;
            $0["no_cursor_colresize"] = true;
            $0["absolute_position_accounts_for_offset"] = true;
            $0["canvas_div_cannot_be_clipped"] = true;
            $0["document_size_use_offsetheight"] = true;
            $0["text_event_charcode"] = false;
            $0["textdeco_on_textdiv"] = true;
            $0["text_ie_carriagereturn"] = true;
            $0["textmeasurementalphastring"] = true;
            if ($4.version >= 10.6) {
                $3.lzswftext.wordWrap = "normal";
                $3.lzswfinputtext.wordWrap = "normal";
                $3.lzswfinputtextmultiline.wordWrap = "normal";
                $0["container_divs_require_overflow"] = true
            };
            if ($4.version >= 10.6) {
                $1["rotation"] = true
            ...
            $2.borderRadius = "MozBorderRadius";
            $2.boxShadow = "MozBoxShadow";
            $2.userSelect = "MozUserSelect";
            $2.transform = "MozTransform";
            $2.transformOrigin = "MozTransformOrigin";
            $0["inputtext_anonymous_div"] = true;
            if ($4.OS == "Windows") {
                $0["clipped_scrollbar_causes_display_turd"] = true;
                $0["input_highlight_bug"] = true
            };
            if ($4.version < 2) {
                $0["firefox_autocomplete_bug"] = true
            } else if ($4.version < 3) {
                $3.lzswftext.lineHeight = "119%";
                $3.lzswfinputtext.lineHeight = "119%";
                $3.lzswfinputtextmultiline.lineHeight = "119%"
            } else if ($4.version < 4) {
                if ($4.subversion < 6) {
        ...
        if ($4.OS == "Mac") {
            $0["detectstuckkeys"] = true;
            $0["alt_key_sends_control"] = true;
            $0["match_swf_letter_spacing"] = true
        };
        if ($4.OS == "Android") {
            $1["touchevents"] = true;
            $1["screenorientation"] = true
        ...
        if (!$4.isIE) {
            $0["fix_clickable"] = false;
            $0["activate_on_mouseover"] = false;
...
LzSprite.prototype.setClickable = function ($0) {
    ...
    if (this.quirks.fix_clickable && this.__LZimg != null) {
        ...
        if (this.quirks.fix_clickable) {
            if (this.quirks.fix_ie_clickable) {
                var $1 = $0 && this.visible ? "" : "none";
                this.__LZclickcontainerdiv.style.display = $1;
                this.__LZclick.style.display = $1
            } else {
...
LzSprite.__setClickable = function ($0, $1) {
    if ($1._clickable === $0) return;
    $1._clickable = $0;
    var $2 = $0 ? LzSprite.__clickDispatcher : null;
    if (LzSprite.prototype.capabilities.touchevents) {
        $1.ontouchstart = $2;
        $1.ongesturestart = $2
    } else {
...
LzSprite.__globalClickDispatcher = function ($0) {
    $0 = $0 || window.event;
    if (!$0) return;
    if (lz.embed.browser.isIE && $0.button == 2) {
        return LzMouseKernel.__handleContextMenu($0)
    };
    var $1 = $0.target || $0.srcElement;
    var $2 = $1 && $1.owner;
    ...
    var $4 = "on" + $0.type;
    if ($4 == "onmouseup") {
        var $5 = LzMouseKernel.__lastMouseDown;
        if ($5 && $5 !== $2) {
            $5.__globalmouseup($0)
        };
        LzMouseKernel.__lastMouseDown = null
    } else if ($4 == "onmousedown") {
        var $6 = LzInputTextSprite.prototype.__focusedSprite;
        if ($6 && $6 !== $2) {
            $6.deselect()
        };
        LzMouseKernel.__lastMouseDown = $2;
        $2.__mouseisdown = true
    ...
    LzMouseKernel.__sendEvent($4, $2.owner);
    return $3
};
LzSprite.__clickDispatcher = function ($0) {
    ...
    if (LzSprite.quirks.ie_mouse_events) {
        if ($3 == "onmouseenter") {
            ...
            if (lz.embed.browser.version < 9) {
                $2.__mouseEvent("onmousedown");
                $2.__mouseEvent("onmouseup");
                $2.__mouseEvent("onclick")
            };
            return false
        } else if ($3 == "ondrag") {
            return false
    ...
    if (LzSprite.prototype.capabilities.touchevents) {
        if ($3 == "ongesturestart") {
            LzSprite.__gesturestart(true, $1);
            return
        } else if ($3 == "ongesturechange") {
            LzMouseKernel.__sendEvent("ongesture", $2.owner, {
                scale: $0.scale,
                rotation: $0.rotation
            });
            return
        } else if ($3 == "ongestureend") {
            LzSprite.__gesturestart(false, $1);
            return
        } else if ($3 == "ontouchstart") {
            if ($0.touches.length != 1) {
                LzMouseKernel.__sendEvent("ontouch", $2.owner, $0.touches);
                return true
            };
            LzSprite.__touchstart(true, $1);
            $3 = "onmousedown";
            ...
            LzMouseKernel.__sendMouseMove($0);
            var $4 = $2.__isMouseOver();
            var $5 = LzMouseKernel.__lastMouseOver === $2;
            if (!$4 && $5) {
            ...
            LzSprite.__touchstart(false, $1);
            $3 = "onmouseup";
            $0.cancelBubble = false;
            if (!$2.__isMouseOver()) {
                var $6 = lz.BrowserUtils.getcallbackfunc($2, "__mouseEvent", ["onmouseupoutside"]);
                setTimeout($6, 0)
            };
            var $6 = lz.BrowserUtils.getcallbackfunc($2, "__mouseEvent", ["onmouseout"]);
            setTimeout($6, 0);
            $6 = lz.BrowserUtils.getcallbackfunc($2, "__mouseEvent", ["onclick"]);
            setTimeout($6, 0)
        } else {
            return true
        }
    ...
    if ($3 == "onmousedown") {
        if ($0.button == 2) return;
        $2.__mouseisdown = true;
        LzMouseKernel.__lastMouseDown = $2;
        var $7 = LzInputTextSprite.prototype.__focusedSprite;
        if ($7 && $7 !== $2) {
            $7.deselect()
        }
    } else if ($3 == "onmouseup") {
        if ($0.button == 2) return;
        var $8 = LzMouseKernel.__lastMouseDown;
        if ($8 && $8 !== $2) {
            $8.__globalmouseup($0)
        };
        if (LzMouseKernel.__lastMouseDown !== $2) {
            LzMouseKernel.__lastMouseDown = null;
            if ($2) $2.__mouseisdown = false;
            return
        } else {
            $2.__mouseisdown = false;
            LzMouseKernel.__lastMouseDown = null
        };
        $0.cancelBubble = false
    };
...
LzSprite.prototype.__mouseEvent = function ($0) {
    if ($0 == "onmousedown") {
        var $1 = LzInputTextSprite.prototype.__focusedSprite;
        if ($1 && $1 != this) {
            $1.deselect()
        }
        ...
        if (this.quirks.activate_on_mouseover) {
            var $2 = LzSprite.__mouseActivationDiv;
            if (!$2.mouseisover) {
                $2.onmouseover()
            }
        }
    ...
    if (this.owner.mouseevent) {
        if (LzMouseKernel.__lastMouseDown) {
            if ($0 == "onmouseover" || $0 == "onmouseout") {
                var $3 = LzMouseKernel.__lastMouseDown === this;
                if ($0 == "onmouseover") {
                    LzMouseKernel.__lastMouseOver = this
                ...
                if ($3) {
                    ...
                    var $4 = $0 == "onmouseover" ? "onmousedragin" : "onmousedragout";
                    LzMouseKernel.__sendEvent($4, this.owner)
                };
                return
            }
        };
...
LzSprite.prototype.__isMouseOver = function ($0) {
    var $1 = this.getMouse();
    var $2 = this.__findParents("visible", false, true);
    if ($2.length) return false;
    return $1.x >= 0 && $1.y >= 0 && $1.x < this.width && $1.y < this.height
};
...
LzSprite.prototype.is_html = false;
...
LzSprite.prototype.setResource = function ($0) {
    ...
    var $1 = LzResourceLibrary[$0];
    var $2 = this.getResourceUrls($0);
    if ($1) {
        ...
        if (this.quirks.use_css_sprites) {
            if (this.quirks.use_css_master_sprite && $1.spriteoffset != null) {
                ...
                this.__cssspriteoffset = $1.spriteoffset
            } else if ($1.sprite) {
                this.__csssprite = this.getBaseUrl($1) + $1.sprite;
...
LzSprite.prototype.setSource = function ($0, $1) {
    ...
    var $2 = $0;
    if ($0.indexOf("http:") == 0 && $0.indexOf("http://") != 0) {
        $0 = $0.substring(5)
    };
    if ($1 == "reset") {
        $1 = false
    ...
    var $3 = this.__ImgPool.get($0, $1 != true);
    this.__bindImage($3);
    if (this.loading) {
...
LzSprite.prototype.__bindImage = function ($0) {
    if (this.__LZimg && this.__LZimg.owner) {
        this.__LZdiv.replaceChild($0, this.__LZimg);
        this.__LZimg = $0
    } else {
        this.__LZimg = $0;
...
LzSprite.prototype.__setBGImage = function ($0) {
    if (this.__LZimg) {
        var $1 = $0 ? "url('" + $0 + "')" : "none";
        this.__bgimage = this.__LZimg.style.backgroundImage = $1
    };
    if ($1 != null) {
        var $2 = -this.__cssspriteoffset || 0;
        this.__LZimg.style.backgroundPosition = "0 " + $2 + "px"
    }
};
...
(function () {
    if (LzSprite.quirks.ie_alpha_image_loader) {
        LzSprite.prototype.__updateIEAlpha = function ($0) {
            var $1 = this.resourceWidth;
            var $2 = this.resourceHeight;
            ...
            if ($1 == null) $1 = this.width == null ? "100%" : this.CSSDimension(this.width);
            if ($2 == null) $2 = this.height == null ? "100%" : this.CSSDimension(this.height);
            $0.style.width = $1;
            $0.style.height = $2
        }
    }
...
LzSprite.prototype.__incrementFrame = function () {
    var $0 = this.frame + 1 > this.frames.length ? 1 : this.frame + 1;
    this.__setFrame($0)
};
(function () {
...
LzSprite.prototype.__preloadFrames = function () {
    ...
    for (var $1 = 0; $1 < $0; $1++) {
        ...
        var $3 = this.__ImgPool.get($2, false, true);
        if (this.quirks.ie_alpha_image_loader) {
            this.__updateIEAlpha($3)
        }
    }
...
LzSprite.prototype.__imgonload = function ($0, $1) {
    ...
    this.resourceWidth = $1 && $0["__LZreswidth"] ? $0.__LZreswidth : $0.width;
    this.resourceHeight = $1 && $0["__LZresheight"] ? $0.__LZresheight : $0.height;
    if (!$1) {
        ...
        if (this.quirks.ie_alpha_image_loader) {
            ...
            $0.__lastcondition = "__imgonload";
            $0.__LZreswidth = this.resourceWidth;
            $0.__LZresheight = this.resourceHeight
        };
        if (this.quirks.ie_alpha_image_loader) {
...
LzSprite.prototype.__destroyImage = function ($0, $1) {
    if ($1) {
        if ($1.owner) {
            var $2 = $1.owner;
            if ($2.__imgtimoutid != null) {
                clearTimeout($2.__imgtimoutid);
                $2.__imgtimoutid = null
            };
            lz.BrowserUtils.removecallback($2)
        };
        LzSprite.prototype.__clearImageEvents($1);
        LzSprite.prototype.__discardElement($1)
    };
    if (LzSprite.quirks.preload_images_only_once) {
...
LzSprite.prototype.__clearImageEvents = function ($0) {
    if (!$0 || $0.__cleared) return;
    if (LzSprite.quirks.ie_alpha_image_loader) {
        var $1 = $0.sizer;
        if ($1) {
            if ($1.tId) clearTimeout($1.tId);
            $1.onerror = null;
            $1.onload = null;
            $1.onloadforeal = null;
            $1._parent = null;
...
LzSprite.prototype.__gotImage = function ($0, $1, $2) {
    if (this.owner.skiponload || $2 == true) {
        this.owner[$1.__lastcondition]({
            width: this.owner.resourceWidth,
            height: this.owner.resourceHeight
        }, true)
    } else {
        if (LzSprite.quirks.ie_alpha_image_loader) {
...
LzSprite.prototype.__getImage = function ($0, $1) {
    if (LzSprite.quirks.ie_alpha_image_loader) {
        ...
        if (this.owner && $1 != true) {
            ...
            var $2 = lz.BrowserUtils.getcallbackfunc(this.owner, "__imgontimeout", [im.sizer]);
            this.owner.__imgtimoutid = setTimeout($2, LzSprite.medialoadtimeout);
            im.sizer.src = $0
        };
        if (!$1) im.style.display = "none";
        ...
        if (this.owner && $1 != true) {
            ...
            var $2 = lz.BrowserUtils.getcallbackfunc(this.owner, "__imgontimeout", [im]);
            this.owner.__imgtimoutid = setTimeout($2, LzSprite.medialoadtimeout)
        };
        im.src = $0
    };
...
LzSprite.prototype.stretchResource = function ($0) {
    $0 = $0 != "none" ? $0 : null;
    if (this.stretches == $0) return;
    this.stretches = $0;
    if (!($0 == null && this.__csssprite) && this.__bgimage) {
...
LzSprite.prototype.__updateStretches = function () {
    ...
    var $0 = this.quirks;
    if ($0.ie_alpha_image_loader) return;
    var $1 = this.__LZimg;
    if ($1) {
        ...
        if (this.stretches == "both") {
            ...
            $1.width = this.resourceWidth;
            $1.height = this.height
        } else if (this.stretches == "width") {
            $1.width = this.width;
            $1.height = this.resourceHeight
        } else {
            $1.width = this.resourceWidth;
            $1.height = this.resourceHeight
        };
...
LzSprite.prototype.__setFrame = function ($0, $1) {
    ...
    this.frame = $0;
    var $3 = this.frames[this.frame - 1];
    if (this.backgroundrepeat) {
        this.__setBGImage($3);
        this.__updateBackgroundRepeat()
    } else if (this.stretches == null && this.__csssprite) {
        ...
        var $4 = (this.frame - 1) * -this.resourceWidth;
        var $5 = -this.__cssspriteoffset || 0;
        this.__LZimg.style.backgroundPosition = $4 + "px " + $5 + "px"
    } else {
...
LzSprite.prototype.setBackgroundRepeat = function ($0) {
...
LzSprite.prototype.getContext = function () {
    ...
    var $0 = document.createElement("canvas");
    $0.owner = this;
    this.__LZcanvas = $0;
    $0.className = "lzgraphicscanvas";
    if (this.__LZdiv.firstChild) {
        this.__LZdiv.insertBefore($0, this.__LZdiv.firstChild)
    } else {
        this.__LZdiv.appendChild($0)
    };
    $0.setAttribute("width", this.width);
    $0.setAttribute("height", this.height);
    if (this.cornerradius != null) {
        this.__applyCornerRadius($0)
    };
...
LzSprite.prototype.setContextCallback = function ($0, $1) {
    this.__canvascallbackscope = $0;
    this.__canvascallbackname = $1
};
...
LzSprite.prototype.setContextMenu = function ($0) {
    ...
    this.__LZcontextcontainerdiv.appendChild($1);
    this.__LZcontext = $1;
...
LzSprite.prototype.setX = function ($0) {
    if ($0 == null || $0 == this.x && this._xoffset == this.xoffset) return;
    this.__poscacheid = -1;
    this._xoffset = this.xoffset;
    this.x = $0;
    $0 = this.CSSDimension($0 + this.xoffset);
    if (this._x != $0) {
        this._x = $0;
        this.__LZdiv.style.left = $0;
        if (this.__LZclickcontainerdiv) {
...
LzSprite.prototype.setWidth = function ($0) {
    if ($0 < 0 || this.width == $0) return;
    this.width = $0;
    $0 = this.CSSDimension($0);
    if (this._w != $0) {
        this._w = $0;
        var $1 = $0;
        var $2 = this.quirks;
        this.applyCSS("width", $1);
        if (this.__LZcontext) this.__LZcontext.style.width = $0;
        ...
        if (this.isroot) {
            ...
            if (this.__LZclick) this.__LZclick.style.width = $0;
...
LzSprite.prototype.setY = function ($0) {
    if ($0 == null || $0 == this.y && this._yoffset == this.yoffset) return;
    this.__poscacheid = -1;
    this.y = $0;
    this._yoffset = this.yoffset;
    $0 = this.CSSDimension($0 + this.yoffset);
    if (this._y != $0) {
        this._y = $0;
        this.__LZdiv.style.top = $0;
        if (this.__LZclickcontainerdiv) {
...
LzSprite.prototype.setHeight = function ($0) {
    ...
    if (this._h != $0) {
        ...
        var $1 = $0;
        var $2 = this.quirks;
        this.applyCSS("height", $1);
        if (this.__LZcontext) this.__LZcontext.style.height = $0;
        if (this.clip) this.__updateClip();
        if (this.isroot) {
            if ($2.container_divs_require_overflow) {
            ...
            if (this.stretches) this.__updateStretches();
            if (this.backgroundrepeat) this.__updateBackgroundRepeat();
            if (this.__LZclick) this.__LZclick.style.height = $0;
            if (this.__LZcanvas) this.__resizecanvas()
        };
        return $0
    }
...
LzSprite.prototype.getWidth = function () {
    var $0 = this.__LZdiv.clientWidth;
    return $0 == 0 ? this.width : $0
};
LzSprite.prototype.getHeight = function () {
    var $0 = this.__LZdiv.clientHeight;
    return $0 == 0 ? this.height : $0
};
LzSprite.prototype.bringToFront = function () {
    if (!this.__parent) {
        return
    };
    var $0 = this.__parent.__children;
    if ($0.length < 2) return;
    $0.sort(LzSprite.prototype.__zCompare);
    this.sendInFrontOf($0[$0.length - 1])
};
LzSprite.prototype.__setZ = function ($0) {
    this.__LZdiv.style.zIndex = $0;
    var $1 = this.quirks;
    if ($1.fix_clickable && this.__LZclickcontainerdiv) {
...
LzSprite._getScrollbarWidth = function () {
    ...
    var $4 = $0.clientWidth;
    LzSprite.prototype.__discardElement($0);
    return $3 - $4
};
LzSprite.setRootX = function ($0) {
    var $1 = LzSprite.__rootSpriteContainer;
    $1.style.position = "absolute";
    $1.style.left = LzSprite.prototype.CSSDimension($0);
    setTimeout(LzScreenKernel.__resizeEvent, 0)
};
LzSprite.setRootWidth = function ($0) {
    LzSprite.__rootSpriteContainer.style.width = LzSprite.prototype.CSSDimension($0);
    setTimeout(LzScreenKernel.__resizeEvent, 0)
};
LzSprite.setRootY = function ($0) {
    var $1 = LzSprite.__rootSpriteContainer;
    $1.style.position = "absolute";
    $1.style.top = LzSprite.prototype.CSSDimension($0);
    setTimeout(LzScreenKernel.__resizeEvent, 0)
};
LzSprite.setRootHeight = function ($0) {
    LzSprite.__rootSpriteContainer.style.height = LzSprite.prototype.CSSDimension($0);
    setTimeout(LzScreenKernel.__resizeEvent, 0)
};
...
LzSprite.prototype.init = function ($0) {
    ...
    if (this.isroot) {
        if (this.quirks["css_hide_canvas_during_init"]) {
            ...
            this.__LZdiv.style[$1] = "";
            if (this.quirks["fix_clickable"]) this.__LZclickcontainerdiv.style[$1] = "";
            if (this.quirks["fix_contextmenu"]) this.__LZcontextcontainerdiv.style[$1] = ""
        };
        if (this._id) {
...
LzSprite.prototype.addChildSprite = function ($0) {
    ...
    this.__LZdiv.appendChild($0.__LZdiv);
    if ($0.__LZclickcontainerdiv) {
        if (!this.__LZclickcontainerdiv) {
            this.__LZclickcontainerdiv = this.__createContainerDivs("click");
            if (this.clip) this.__updateClip()
        };
...
LzSprite.prototype.setMaxLength = function ($0) {};
LzSprite.prototype.setPattern = function ($0) {};
...
LzSprite.prototype.setBGColor = function ($0) {
    if ($0 != null && !this.capabilities.rgba) {
        switch (LzColorUtils.alphafrominternal($0)) {
            ...
            case 1:
                $0 = LzColorUtils.colorfrominternal($0);
                break;

        }
    };
    if (this.bgcolor === $0) return;
    this.bgcolor = $0;
    this.__LZdiv.style.backgroundColor = $0 === null ? "transparent" : LzColorUtils.torgb($0);
...
LzSprite.prototype.setFilter = function ($0, $1) {
    if (this.__filters == null) {
        this.__filters = {}
    };
    this.__filters[$0] = $1;
    var $2 = "";
    for (var $3 in this.__filters) {
        $2 += this.__filters[$3]
    };
    return $2
};
LzSprite.prototype.setOpacity = function ($0) {
    ...
    if (this.opacity == $0 || $0 < 0) return;
    var $1 = this.opacity == 0 || $0 == 0;
    this.opacity = $0;
    var $2 = 100;
...
LzSprite.prototype.__processHiddenParents = function ($0) {
    var $1 = this.__findParents("visible", false);
    var $2 = $1.length;
    for (var $3 = 0; $3 < $2; $3++) {
        $1[$3].__LZdiv.style.display = ""
    };
    var $4 = Array.prototype.slice.call(arguments, 1);
    var $5 = $0.apply(this, $4);
    for (var $3 = 0; $3 < $2; $3++) {
        var $6 = $1[$3];
        $6.__LZdiv.style.display = $6.__csscache.__LZdivdisplay || ""
    };
    return $5
};
...
LzSprite.prototype.getMouse = function () {
    var $0 = this.__getPos();
    return {
        x: LzMouseKernel.__x - $0.x,
        y: LzMouseKernel.__y - $0.y
    }
};
...
LzSprite.prototype.__getPos = function () {
    ...
    var $0 = false;
    var $1 = true;
    var $2 = LzSprite.__rootSprite;
    var $3, $4;
    for (var $5 = this; $5 !== $2; $5 = $3) {
        $3 = $5.__parent;
        if ($3) {
    ...
    if ($0 && $1) {
        var $6 = ++LzSprite.__poscachecnt;
        for (var $5 = this; $5 !== $4; $5 = $5.__parent) {
            $5.__poscache = null;
            $5.__poscacheid = $6
        }
    };
    var $7 = this.__poscache;
    if (!$7) {
        $7 = this.__processHiddenParents(lz.embed.getAbsolutePosition, this.__LZdiv);
        if ($1) {
            this.__poscache = $7
        }
    };
...
LzSprite.prototype.__discardElement = function ($0) {
    ...
    if ($0.parentNode) $0.parentNode.removeChild($0)
};
LzSprite.prototype.__setCSSClassProperty = function ($0, $1, $2) {
    var $3 = document.all ? "rules" : "cssRules";
    var $4 = document.styleSheets;
    var $5 = $4.length - 1;
    for (var $6 = $5; $6 >= 0; $6--) {
        var $7 = $4[$6][$3];
        if ($7 && $7["length"]) {
...
LzSprite.prototype.__createContainerDivs = function ($0) {
    var $1 = "__LZ" + $0 + "containerdiv";
    var $2 = true;
    if (this[$1]) {
        return this[$1]
    };
    var $3 = this.__findParents($1, null);
    for (var $4 = $3.length - 1; $4 >= 0; $4--) {
        var $5 = $3[$4];
        var $6 = document.createElement("div");
        $6.className = $5 instanceof LzTextSprite ? "lztextcontainer" : "lzdiv";
        var $7 = $5.__parent && $5.__parent[$1];
        if ($7) {
            $7.appendChild($6)
        };
        this.__copystyles($5.__LZdiv, $6);
        if ($5._id && !$6.id) {
            $6.id = $0 + $5._id
        };
        $6.owner = $5;
...
LzSprite.prototype.setRotation = function ($0) {
    ...
    this.rotation = $0;
    this._rotation = "rotate(" + $0 + "deg) ";
    this.__updateTransform()
};
LzSprite.prototype._transform = "";
LzSprite.prototype.__updateTransform = function ($0) {
    var $1 = (this._xscale || "") + (this._yscale || "") + (this._rotation || "");
    var $2 = lz.embed.browser;
    if ($2.isIE && $2.version >= 9) this.__LZdiv.style["-ms-transform"] = $1;
    if ($1 === this._transform) return;
    this._transform = $1;
    var $3 = LzSprite.__styleNames.transform;
    this.__LZdiv.style[$3] = $1;
    if (this.__LZclickcontainerdiv) {
...
(function () {
    ...
    if (LzSprite.quirks.ie_leak_prevention) {
        ...
        LzSprite.prototype.__discardElement = function ($0) {
            if (!$0 || !$0.nodeType) return;
            if ($0.nodeType >= 1 && $0.nodeType < 13) {
                if ($0.owner) $0.owner = null;
                var $1 = document.getElementById("__LZIELeakGarbageBin");
                if (!$1) {
                    $1 = document.createElement("DIV");
                    $1.id = "__LZIELeakGarbageBin";
...
LzSprite.prototype.setAADescription = function ($0) {
    var $1 = this.aadescriptionDiv;
    if ($1 == null) {
        this.aadescriptionDiv = $1 = document.createElement("LABEL");
        $1.className = "lzaccessibilitydiv";
        if (!this.__LZdiv.id) this.__LZdiv.id = "sprite_" + this.uid;
        $1.setAttribute("for", this.__LZdiv.id);
        this.__LZdiv.appendChild($1)
    };
    $1.innerHTML = $0
};
...
LzSprite.prototype.setAAActive = function ($0) {
    this.__LzAccessibilityActive = $0
};
LzSprite.prototype.setAASilent = function ($0) {};
LzSprite.prototype.setAAName = function ($0) {};
LzSprite.prototype.setAATabIndex = function ($0) {};
LzSprite.prototype.sendAAEvent = function ($0, $1, $2) {
    try {
        if (this.__LZdiv != null) {
            this.__LZdiv.focus()
        }
...
LzSprite.prototype.setID = function ($0) {
    ...
    if (!this.__LZdiv.id) this.__LZdiv.id = this._dbg_typename + $0;
    if (this.__LZclickcontainerdiv && !this.__LZclickcontainerdiv.id) this.__LZclickcontainerdiv.id = "click" + $0;
    if (this.__LZcontextcontainerdiv && !this.__LZcontextcontainerdiv.id) this.__LZcontextcontainerdiv.id = this.__LZcontextcontainerdiv.id = "context" + $0
};
...
LzSprite.prototype.__docanvascallback = function () {
    var $0 = this.__canvascallbackscope[this.__canvascallbackname];
    if ($0) {
        $0.call(this.__canvascallbackscope, this.__LZcanvas.getContext("2d"));
        if (LzSprite.quirks.resize2dcanvas) {
            var $1 = this.__LZcanvas.firstChild;
            $1.style.width = this._w;
            $1.style.height = this._h
        }
    }
};
LzSprite.prototype.__initcanvasie = function () {
    ...
    if (--this.__maxTries > 0) {
        var $1 = lz.BrowserUtils.getcallbackstr(this, "__initcanvasie");
        this.__canvasTId = setTimeout($1, 50)
    }
};
LzSprite.prototype.__getShadowCSS = function ($0, $1, $2, $3) {
    ...
    if (this.quirks.use_filter_for_dropshadow) {
        var $5 = LzColorUtils.inttohex(LzColorUtils.colorfrominternal($0));
        if ($1 == 0) {
            this.applyCSS("left", this.x - $3);
            this.applyCSS("top", this.y - $3);
            return "progid:DXImageTransform.Microsoft.Glow(Color='" + $5 + "',Strength=" + $3 + ")"
        } else {
            this.applyCSS("left", this.x);
            this.applyCSS("top", this.y);
            $2 += 90;
            return "progid:DXImageTransform.Microsoft.Shadow(Color='" + $5 + "',Direction=" + $2 + ",Strength=" + $1 + ")"
        }
    } else {
        var $6 = $2 * Math.PI / 180;
        var $7 = this.CSSDimension(Math.cos($6) * $1);
        var $8 = this.CSSDimension(Math.sin($6) * $1);
        var $5 = LzColorUtils.cssfrominternal($0);
        return $4 + $5 + " " + $7 + " " + $8 + " " + this.CSSDimension($3)
    }
};
LzSprite.prototype.shadow = null;
LzSprite.prototype.updateShadow = function ($0, $1, $2, $3) {
    var $4 = this.__getShadowCSS($0, $1, $2, $3);
    if ($4 === this.shadow) return;
    this.shadow = $4;
    if (this.quirks.use_filter_for_dropshadow) {
        this.__LZdiv.style.filter = this.setFilter("shadow", $4)
    } else {
        var $5 = LzSprite.__styleNames.boxShadow;
        if (this.__LZcanvas) {
            this.__LZdiv.style[$5] = "";
            this.__LZcanvas.style[$5] = $4
        } else {
...
LzSprite.prototype.setCornerRadius = function ($0) {
    ...
    var $4 = $0.slice(0, 4).join(" ");
    var $5 = $0.slice(4).join(" ");
    $1 = $4 + " / " + $5;
    if ($1 == this.cornerradius) return;
    this.cornerradius = $1;
    this.cornerradius_h = $4;
    this.cornerradius_v = $5;
...
LzSprite.prototype.__applyCornerRadius = function ($0) {
    var $1 = LzSprite.__styleNames;
    if (this.quirks.explicitly_set_border_radius) {
        var $2 = this.cornerradius_h.split(" ");
        var $3 = this.cornerradius_v.split(" ");
        $0.style[$1.borderTopLeftRadius] = $2[0] + " " + $3[0];
        $0.style[$1.borderTopRightRadius] = $2[1] + " " + $3[1];
        $0.style[$1.borderBottomRightRadius] = $2[2] + " " + $3[2];
        $0.style[$1.borderBottomLeftRadius] = $2[3] + " " + $3[3]
    } else {
...
LzSprite.prototype.set_borderColor = function ($0) {
    if ($0 == null) $0 = "";
    this.__LZdiv.style.borderColor = $0
};
LzSprite.prototype.set_borderWidth_internal = function ($0, $1) {
    if ($1 == 0) {
        $1 = ""
    };
    var $2 = "border" + $0 + "Width";
    this.__LZdiv.style[$2] = $1;
    if (this.__LZclick) {
...
LzSprite.setMediaLoadTimeout = function ($0) {
...
LzSprite.prototype.setXScale = function ($0) {
    if (this.xscale == $0) return;
    this.xscale = $0;
    this._xscale = "scaleX(" + $0 + ") ";
    this.__updateTransform()
};
LzSprite.prototype.yscale = 1;
LzSprite.prototype.setYScale = function ($0) {
    if (this.yscale == $0) return;
    this.yscale = $0;
    this._yscale = "scaleY(" + $0 + ") ";
    this.__updateTransform()
};
...
LzTextSprite.prototype.__initTextProperties = function ($0) {
    this.setFontName($0.font);
    this.setFontStyle($0.fontstyle);
    this.setFontSize($0.fontsize);
    this.setTextColor($0.fgcolor)
};
...
LzTextSprite.prototype.setFontSize = function ($0) {
    if ($0 == null || $0 < 0) return;
    var $1 = this.CSSDimension($0);
    if (this._fontSize != $1) {
        this._fontSize = $1;
        this.scrolldiv.style.fontSize = $1;
        if (this.quirks["emulate_flash_font_metrics"]) {
            var $2 = Math.round($0 * 1.2);
            this.scrolldiv.style.lineHeight = this.CSSDimension($2);
            this._lineHeight = $2
        };
...
LzTextSprite.prototype.setFontStyle = function ($0) {
    ...
    if ($1 != this._fontWeight) {
        this._fontWeight = $1;
        this.scrolldiv.style.fontWeight = $1;
        $2 = true
    };
    if ($0 != this._fontStyle) {
        this._fontStyle = $0;
        this.scrolldiv.style.fontStyle = $0;
        $2 = true
    };
    if ($2) {
        this.__updatefieldsize()
...
LzTextSprite.prototype.setFontName = function ($0) {
    if ($0 != this._fontFamily) {
        this._fontFamily = $0;
        this.scrolldiv.style.fontFamily = $0;
        this.__updatefieldsize()
    }
};
...
LzTextSprite.prototype.setTextColor = function ($0) {
    if (this.textcolor === $0) return;
    this.textcolor = $0;
    this.__LZdiv.style.color = LzColorUtils.inttohex($0)
};
...
LzTextSprite.prototype.setScrolling = function ($0) {
    var $1 = this.className;
    if ($1 == "lzswftext" || $1 == "lzswfinputtextmultiline") {
        var $2 = this.height;
        var $3 = this.width;
        var $4 = this.CSSDimension;
        if ($0 || $1 == "lzswfinputtextmultiline") {
            this.scrolling = $0;
...
LzTextSprite.prototype.setScrollEvents = function ($0) {
    this.scrollevents = this.setScrolling($0);
    this.__updatefieldsize()
};
LzTextSprite.prototype.__updatefieldsizeTID = null;
LzTextSprite.prototype.__updatefieldsize = function () {
    var $0 = LzFontManager.isFontLoaded(this, this._fontFamily, this._fontStyle, this._fontWeight);
    if (!$0 || !this.initted) return;
    this.owner._updateSize();
    var $1 = lz.BrowserUtils.getcallbackfunc(this, "__updatefieldsizeCallback", []);
...
LzTextSprite.prototype.__updatefieldsizeCallback = function () {
    var $0 = this.getLineHeight();
    if (this.lineHeight !== $0) {
        this.lineHeight = $0;
        this.owner.scrollevent("lineHeight", $0)
    };
...
LzTextSprite.prototype.__updatefieldprop = function ($0) {
    var $1 = this.scrolldiv[$0];
    if (this[$0] !== $1 || $0 == "scrollHeight") {
        this[$0] = $1;
        this.owner.scrollevent($0, $1)
    }
};
LzTextSprite.prototype.setText = function ($0, $1) {
    ...
    if ($1 != true && this.text == $0) return;
    this.text = $0;
    this.scrolldiv.innerHTML = $0;
    this.__updatefieldsize()
};
...
LzTextSprite.prototype.setMultiline = function ($0) {
    ...
    if ($0) {
        ...
        var $1 = this.className === "lzswfinputtextmultiline" ? "pre-wrap" : "nowrap";
        this.applyCSS("overflow", "", "scrolldiv")
    };
    if (this._whiteSpace !== $1) {
        this._whiteSpace = $1;
        this.scrolldiv.style.whiteSpace = $1
    };
...
LzTextSprite.prototype.getTextWidth = function ($0) {
    if (!this.initted && !$0) return 0;
    var $1;
    var $2 = this.className + "/" + this.scrolldiv.style.cssText;
    var $3 = this._cachevalue;
    if (this._cacheStyleKey == $2 && this._cacheTextKey == this.text && ("width" in $3)) {
        $1 = $3.width
    } else {
...
LzTextSprite.prototype.getLineHeight = function () {
    ...
    var $0 = this.className + "/" + this.scrolldiv.style.cssText;
    var $1 = this._cachevalue;
    if (this._cacheStyleKey == $0 && ("lineheight" in $1)) {
        var $2 = $1.lineheight
    } else {
...
LzTextSprite.prototype.getTextfieldHeight = function ($0) {
    ...
    if (this.multiline && this.text != "") {
        var $2 = this.className + "/" + this.scrolldiv.style.cssText;
        var $3 = this._cachevalue;
        if (this._cacheStyleKey == $2 && this._cacheTextKey == this.text && ("height" in $3)) {
            $1 = $3.height
        } else {
...
(function () {
    if (LzSprite.quirks.ie_leak_prevention) {
        ...
        LzTextSprite.prototype.__cleanupdivs = function () {
            var $0 = LzTextSprite.prototype.__divstocleanup;
            var $1 = LzSprite.prototype.__discardElement;
            var $2 = $0.length;
            for (var $3 = 0; $3 < $2; $3++) {
                $1($0[$3])
            };
...
LzTextSprite.prototype.getTextDimension = function ($0) {
    var $1 = this.text;
    var $2 = "auto";
    switch ($0) {
        case "lineheight":
    ...
    var $3 = this.scrolldiv;
    var $4 = this.className;
    var $5 = $4 + "/" + $3.style.cssText;
    var $6 = this._cachevalue;
    if (this._cacheStyleKey == $5 && ($0 == "lineheight" || this._cacheTextKey == $1) && ($0 in $6)) {
        return $6[$0]
    };
    this._cacheStyleKey = $5;
    if ($0 != "lineheight") {
        this._cacheTextKey = $1
    };
    var $7 = "padding:0px;overflow:visible;width:" + $2 + ";height:auto;" + (this._fontSize ? "font-size:" + this._fontSize + ";" : "") + (this._fontWeight ? "font-weight:" + this._fontWeight + ";" : "") + (this._fontStyle ? "font-style:" + this._fontStyle + ";" : "") + (this._fontFamily ? "font-family:" + this._fontFamily + ";" : "") + (this._fontSize ? "font-size:" + this._fontSize + ";" : "") + (this._letterSpacing ? "letter-spacing:" + this._letterSpacing + ";" : "") + (this._whiteSpace ? "white-space:" + ($0 == "width" ? "pre" : this._whiteSpace) + ";" : "");
    this._cachevalue = LzFontManager.getSize($0, $4, $7, this.scrolldivtagname, $1);
    return this._cachevalue[$0]
};
LzTextSprite.prototype.setSelectable = function ($0) {
    this.selectable = $0;
    this.__LZdiv.style.cursor = $0 ? "auto" : "";
    if (this.quirks["prevent_selection_with_onselectstart"]) {
        var $1 = $0 ? this.__onselectstartHandler : this.__cancelhandler;
        this.__LZdiv.onselectstart = $1
    } else {
        var $2 = $0 ? "text" : "none";
        var $3 = LzSprite.__styleNames.userSelect;
        this.__LZdiv.style[$3] = $2
    };
    if (!this.quirks.fix_clickable) {
        if ($0) {
...
LzTextSprite.prototype.__mouseEvent = function ($0) {
    this.$LzSprite$__mouseEvent($0);
...
LzTextSprite.prototype.setResize = function ($0) {
    this.resize = $0;
    this.applyCSS("overflow", $0 ? "" : "hidden", "scrolldiv")
};
LzTextSprite.prototype.setSelection = function ($0, $1) {
    ...
    if (this.quirks["text_selection_use_range"]) {
        var $2 = document.body.createTextRange();
        $2.moveToElementText(this.scrolldiv);
        if ($0 > $1) {
            var $3 = $0;
            $0 = $1;
            $1 = $3
        ...
        var $3 = $0;
        var $4 = $1 - $2.text.length;
        $2.moveStart("character", $3);
        $2.moveEnd("character", $4);
        $2.select()
    } else {
        var $2 = document.createRange();
        var $5 = 0;
        $2.setStart(this.scrolldiv.childNodes[0], $0);
        $2.setEnd(this.scrolldiv.childNodes[0], $1);
        var $6 = window.getSelection();
        $6.removeAllRanges();
        $6.addRange($2)
    }
};
LzTextSprite.prototype.__findNodeByOffset = function ($0) {
    var $1 = this.scrolldiv.childNodes[0];
    var $2 = 0;
    while ($1) {
        if ($1.nodeType == 3) {
    ...
    try {
        if ($0) {
            if (this.quirks["text_selection_use_range"]) {
                ...
                var $1 = document.createRange();
                $1.setStart($0.anchorNode, $0.anchorOffset);
                $1.setEnd($0.focusNode, $0.focusOffset);
                return $1
            }
        }
    } catch ($2) {}
...
LzTextSprite.prototype.__textareaToRange = function ($0) {
    var $1 = $0.getBookmark();
    var $2, $3;
    $3 = $2 = this.scrolldiv.innerHTML;
    var $4 = this.__getRangeOwner($0);
    if (!($4 instanceof LzTextSprite)) {
        return
    };
    do {
        var $5 = "~~~" + Math.random() + "~~~"
    ...
    $0.text = $5 + $0.text + $5;
    $2 = this.scrolldiv.innerHTML;
    $2 = $2.replace("<BR>", " ");
    var $6 = {};
    $6.startOffset = $2.indexOf($5);
    $2 = $2.replace($5, "");
    $6.endOffset = $2.indexOf($5);
    this.scrolldiv.innerHTML = $3;
    $0.moveToBookmark($1);
    $0.select();
    return $6
};
...
LzTextSprite.prototype.getSelectionPosition = function () {
    var $0 = this.__getGlobalRange();
    if (this.__getRangeOwner($0) === this) {
        if (this.quirks["text_selection_use_range"]) {
...
LzTextSprite.prototype.getSelectionSize = function () {
    ...
    if (this.__getRangeOwner($0) === this) {
        if (this.quirks["text_selection_use_range"]) {
            ...
            if (this.multiline) {
                var $1 = this.__getOffset($0.startContainer);
                var $2 = this.__getOffset($0.endContainer);
                return $0.endOffset + $2 - ($0.startOffset + $1)
            }
        };
...
LzTextSprite.prototype.setYScroll = function ($0) {
...
LzTextSprite.prototype.setX = function ($0) {
    var $1 = this.scrolling;
    var $2 = $1 && this.quirks["clipped_scrollbar_causes_display_turd"];
    if ($1) {
        var $3 = this.scrolldiv;
        var $4 = $3.scrollLeft;
        var $5 = $3.scrollTop;
        if ($2) {
            this.applyCSS("overflow", "hidden", "scrolldiv");
            $3.style.paddingRight = $3.style.paddingBottom = this.quirks.scrollbar_width
        }
    };
    this.$LzSprite$setX($0);
    if ($1) {
        if ($2) {
            this.applyCSS("overflow", "scroll", "scrolldiv");
            $3.style.paddingRight = $3.style.paddingBottom = "0"
        };
        $3.scrollLeft = $4;
        $3.scrollTop = $5
    }
...
LzTextSprite.prototype.setWidth = function ($0) {
    ...
    var $3 = $2;
    var $4 = this.__LZtextIndent < 0 ? -1 * this.__LZtextIndent : 0;
    if ($2 >= $4) {
        $2 -= $4
    };
    var $5 = this.CSSDimension;
    var $6 = $5($2);
    if ($6 !== this.__widthcss) {
        this.__widthcss = $6;
        var $7 = this.scrolldiv;
        $7.style.width = $6;
        if (this.scrolling) {
            var $8 = $5(this.height || 0);
            var $9 = $5($3);
            $7.style.clip = "rect(0 " + $9 + " " + $8 + " 0)"
        }
    };
    return $2
};
...
LzTextSprite.prototype.setHeight = function ($0) {
    ...
    var $3 = this.CSSDimension;
    var $4 = $3($2);
    if ($4 !== this.__heightcss) {
        this.__heightcss = $4;
        var $5 = this.scrolldiv;
        this.__lineheight = $5.style.lineHeight;
        $5.style.height = $4;
        if (this.quirks.fix_ie_divheight_change) {
            $5.style.lineHeight = "inherit";
            var $6 = lz.BrowserUtils.getcallbackfunc(this, "__updatewhitespace", []);
            setTimeout($6, 0)
        };
        if (this.scrolling) {
            var $7 = $3(this.width || 0);
            $5.style.clip = "rect(0 " + $7 + " " + $4 + " 0)"
        }
    };
    this.__updatefieldsize();
    return $2
};
LzTextSprite.prototype.enableClickableLinks = function ($0) {};
LzTextSprite.prototype.makeTextLink = function ($0, $1) {
    LzTextSprite.addLinkID(this);
    var $2 = this.uid;
    return '<span class="lztextlink" onclick="javascript:$modules.lz.__callTextLink(\'' + $2 + "', '" + $1 + "')\">" + $0 + "</span>"
};
$modules.lz.__callTextLink = function ($0, $1) {
    var $2 = LzTextSprite.linkIDMap[$0];
    if ($2 != null) {
        $2.owner.ontextlink.sendEvent($1)
    }
};
LzTextSprite.linkIDMap = [];
LzTextSprite.addLinkID = function ($0) {
...
LzTextSprite.prototype.setTextAlign = function ($0) {
    if (this._textAlign != $0) {
        this._textAlign = $0;
        this.scrolldiv.style.textAlign = $0
    }
};
LzTextSprite.prototype.setTextIndent = function ($0) {
    var $1 = this.CSSDimension($0);
    if (this._textIndent != $1) {
        var $2 = $0 < 0 || this.__LZtextIndent < 0;
        this._textIndent = $1;
        this.__LZtextIndent = $0;
        this.scrolldiv.style.textIndent = $1;
        if ($2) {
            this.scrolldiv.style.paddingLeft = $0 >= 0 ? "" : $1.substr(1);
            var $3 = this.setWidth(this.width)
        }
    }
};
...
LzInputTextSprite.prototype.__createInputText = function ($0) {
    ...
    this.__createInputDiv($1);
    $0 = $0 || "";
    this.__LzInputDiv.setAttribute("value", $0);
    if (this.quirks.fix_clickable) {
        if (this.quirks.fix_ie_clickable) {
        ...
        if (this.quirks.input_highlight_bug) {
            ...
            $2.style.width = 0;
            this.__LZclickcontainerdiv.appendChild($2);
            $2.appendChild(this.__LZinputclickdiv)
        } else {
...
LzInputTextSprite.prototype.__createInputDiv = function ($0) {
    ...
    if ($0 === "password") {
        ...
        this.__LzInputDiv = document.createElement($1);
    ...
    this.scrolldivtagname = $1;
    this.scrolldiv.owner = this;
    this.setScrolling(this.multiline)
};
LzInputTextSprite.prototype.setMultiline = function ($0) {
    var $1 = this.multiline;
    this.multiline = $0;
    if (this.multiline !== $1) {
        var $2 = this.__LzInputDiv;
        this.__setTextEvents(false);
        this.__createInputDiv($0 ? "multiline" : "");
        var $3 = this.__LzInputDiv;
        $3.setAttribute("style", $2.style.cssText);
        if (this.quirks["fix_ie_css_syntax"]) {
            $3.style.fontStyle = $2.style.fontStyle;
            $3.style.fontWeight = $2.style.fontWeight;
            $3.style.fontSize = $2.style.fontSize;
            $3.style.fontFamily = $2.style.fontFamily;
            $3.style.color = $2.style.color
        };
        var $4 = $2.scrollLeft;
        var $5 = $2.scrollTop;
        this.__discardElement($2);
        this.__LZdiv.appendChild($3);
        $3.style.margin = "0px";
        if (!$0) $3.style.height = "auto";
        $3.scrollLeft = $4;
        $3.scrollTop = $5;
...
LzInputTextSprite.prototype.__show = function () {
    ...
    if (this.quirks["inputtext_parents_cannot_contain_clip"]) {
        var $0 = this.__findParents("clip", true);
        var $1 = $0.length;
        if ($1 > 1) {
            if (this._shownclipvals == null) {
                this._shownclipvals = [];
                this._shownclippedsprites = $0;
                for (var $2 = 0; $2 < $1; $2++) {
                    var $3 = $0[$2];
                    this._shownclipvals[$2] = $3.__LZclickcontainerdiv.style.clip;
                    var $4 = this.quirks["fix_ie_css_syntax"] ? "rect(auto auto auto auto)" : "";
                    $3.__LZclickcontainerdiv.style.clip = $4
                }
            }
        }
    };
...
LzInputTextSprite.prototype.__hideIfNotFocused = function ($0) {
    var $1 = LzInputTextSprite.prototype;
    if ($1.__lastshown == null) return;
    var $2 = LzSprite.quirks;
    if ($2.textgrabsinputtextfocus) {
        var $3 = window.event;
        if ($3 && $3.srcElement && $3.srcElement.owner && $3.srcElement.owner instanceof LzTextSprite) {
            if ($0 == "onmousedown") {
    ...
    if (this.quirks["inputtext_parents_cannot_contain_clip"]) {
        if (this._shownclipvals != null) {
            for (var $1 = 0; $1 < this._shownclipvals.length; $1++) {
                ...
                $2.__LZclickcontainerdiv.style.clip = this._shownclipvals[$1]
            };
...
LzInputTextSprite.prototype.setText = function ($0) {
    ...
    this.text = $0;
    this.__createInputText($0);
    this.__LzInputDiv.value = $0;
    this.__updatefieldsize()
};
LzInputTextSprite.prototype.__setTextEvents = function ($0) {
    var $1 = this.__LzInputDiv;
    var $2 = $0 ? this.__textEvent : null;
    $1.onblur = $2;
    $1.onfocus = $2;
    ...
    $1.onkeypress = $2;
    $1.onchange = $2;
    $1.onpaste = this.__pasteText
};
LzInputTextSprite.prototype.__pasteHandlerEx = function ($0) {
    var $1 = !(!this.restrict);
    var $2 = this.multiline && this.owner.maxlength > 0;
    if ($1 || $2) {
        $0 = $0 || window.event;
        if (this.quirks.safari_paste_event) {
            var $3 = $0.clipboardData.getData("text/plain")
        } else {
            var $3 = window.clipboardData.getData("TEXT");
            $3 = $3.replace(this.____crregexp, "\n")
        };
        var $4 = false;
        var $5 = this.getSelectionSize();
        if ($5 < 0) $5 = 0;
        if ($1) {
            var $6 = $3.match(this.restrict);
            if ($6 == null) {
                var $7 = ""
            } else {
                var $7 = $6.join("")
        ...
        if ($4) {
            ...
            if ($3.length > 0) {
                if (this.quirks.safari_paste_event) {
                    var $b = this.__LzInputDiv.value;
                    var $c = this.getSelectionPosition();
                    this.text = $b.substring(0, $c) + $3 + $b.substring($c + $5);
                    this.__LzInputDiv.value = this.text;
                    $c += $3.length;
                    this.__LzInputDiv.setSelectionRange($c, $c)
                } else {
...
LzInputTextSprite.prototype.__pasteHandler = function () {
    ...
    setTimeout(function () {
        var $0 = !(!that.restrict);
        var $1 = that.multiline && that.owner.maxlength > 0;
        var $2 = that.__LzInputDiv.value;
        var $3 = $2.length;
        var $4 = that.owner.maxlength;
        if ($0 || $1 && $3 > $4) {
            var $5 = val.length;
            var $6 = $2.substr(selpos, $3 - $5 + selsize);
            if ($0) {
                var $7 = $6.match(that.restrict);
                $6 = $7 != null ? $7.join("") : ""
            };
            if ($1) {
                var $8 = $4 + selsize - $5;
            ...
            that.text = val.substring(0, selpos) + $6 + val.substring(selpos + selsize);
...
LzInputTextSprite.prototype.__pasteText = function ($0) {
    ...
    setTimeout(function () {
        var $0 = that.value;
        that.owner.text = $0;
        view.inputtextevent("onchange", $0)
    }, 10)
};
LzInputTextSprite.prototype.__textEvent = function ($0) {
    $0 = $0 || window.event;
    var $1 = this.owner;
    if ($1.__LZdeleted == true) return;
    if ($1.__skipevent) {
        $1.__skipevent = false;
        return
    };
    var $2 = $0.target || $0.srcElement;
    var $3 = $2 && $2.owner;
    var $4 = "on" + $0.type;
    if (LzSprite.quirks.ie_mouse_events) {
        if ($4 === "onmouseleave") {
    ...
    var $5 = $1.quirks;
    if ($4 === "onmousedown" || $4 === "onmouseup" || $4 === "onmouseout" || $4 === "onmousemove") {
        if ($5.autoscroll_textarea) {
            if ($4 === "onmousedown") {
                ...
                if ($1.dragging) {
                    var $6 = $1.__LzInputDiv;
                    var $7 = $0.pageY - $6.offsetTop;
                    if ($7 <= 3) {
    ...
    if ($1.__shown != true) {
        if ($4 === "onfocus") {
            var $9 = lz.Focus.getFocus();
            var $a = $9 != null && $9.sprite.is_html;
            $1.__show();
            $1.__LzInputDiv.blur();
            LzInputTextSprite.prototype.__lastfocus = $1;
            LzKeyboardKernel.setKeyboardControl(true);
            if ($a) {
                return
            };
    ...
    if ($4 === "onfocus") {
        ...
        if (LzInputTextSprite.prototype.__focusedSprite === $1) {
            LzInputTextSprite.prototype.__focusedSprite = null
        };
        $1.__hide();
        if ($1._cancelblur) {
        ...
        if ($1.restrict || $1.multiline && $b.maxlength && $b.maxlength < Infinity) {
            var $c = $0.keyCode;
            var $d = $5.text_event_charcode ? $0.charCode : $0.keyCode;
            var $e = !($0.ctrlKey || $0.altKey) && ($d >= 32 || $c === 13);
            if ($e) {
                var $f = false;
                if ($c != 13 && $1.restrict) {
                    $f = 0 > String.fromCharCode($d).search($1.restrict)
                };
                if (!$f) {
                    var $g = $1.getSelectionSize();
                    if ($g <= 0) {
                        if ($5.text_ie_carriagereturn) {
                            var $h = $1.__LzInputDiv.value.replace($1.____crregexp, "\n")
                        } else {
                            var $h = $1.__LzInputDiv.value
                        };
                        var $i = $h.length,
                            $j = $b.maxlength;
                        if ($i >= $j) {
                ...
                if ($5.keypress_function_keys) {
                    var $k = false;
                    if ($0.ctrlKey && !$0.altKey && !$0.shiftKey) {
                    ...
                    if ($k) {
                        if ($1.restrict) {
                            ...
                            var $i = $1.__LzInputDiv.value.length,
                                $j = $b.maxlength;
                            if ($i < $j || $1.getSelectionSize() > 0) {
                                $1.__pasteHandler()
                            } else {
                                $0.returnValue = false;
                                if ($0.preventDefault) {
    ...
    if ($b) {
        if ($4 === "onkeydown" || $4 === "onkeyup") {
            ...
            if ($m != $1.text) {
                ...
                $b.inputtextevent("onchange", $m)
            };
            if ($5.autoscroll_textarea && $4 === "onkeydown" && $6.selectionStart === $m.length) {
...
LzInputTextSprite.prototype.setSelection = function ($0, $1) {
    ...
    LzInputTextSprite.prototype.__lastfocus = this;
    if (this.quirks["text_selection_use_range"]) {
        var $3 = this.__LzInputDiv.createTextRange();
        ...
        if (this.multiline) {
            ...
            var $a = $3.text.length;
            var $5 = $0;
            var $b = $1 - $4.length + $7 + $8 + $9 + 1
        } else {
            var $5 = $0;
            var $b = $1 - $3.text.length
        };
        $3.moveStart("character", $5);
        $3.moveEnd("character", $b);
        $3.select()
    } else {
...
(function () {
    if (LzSprite.quirks["text_selection_use_range"]) {
        LzInputTextSprite.prototype._getTextSelection = function () {
            this.__LzInputDiv.focus();
            var $0 = document.selection.createRange();
            var $1 = $0.getBookmark();
            var $2 = contents = this.__LzInputDiv.value;
            do {
                var $3 = "~~~" + Math.random() + "~~~"
            } while (contents.indexOf($3) != -1);
            var $4 = $0.parentElement();
            if ($4 == null || !($4.type == "text" || $4.type == "textarea")) {
                return
            };
            $0.text = $3 + $0.text + $3;
            contents = this.__LzInputDiv.value;
            var $5 = {};
            $5.start = contents.indexOf($3);
            contents = contents.replace($3, "");
            $5.end = contents.indexOf($3);
            this.__LzInputDiv.value = $2;
            $0.moveToBookmark($1);
            $0.select();
            return $5
        };
        LzInputTextSprite.prototype._getTextareaSelection = function () {
            var $0 = this.__LzInputDiv;
            var $1 = document.selection.createRange().duplicate();
            if ($1.parentElement() == $0) {
                var $2 = document.body.createTextRange();
                $2.moveToElementText($0);
                $2.setEndPoint("EndToStart", $1);
                var $3 = document.body.createTextRange();
                $3.moveToElementText($0);
                $3.setEndPoint("StartToEnd", $1);
                var $4 = false,
                    $5 = false,
                    $6 = false;
                var $7, $8, $9, $a, $b, $c;
...
LzInputTextSprite.prototype.setFontSize = function ($0) {
    this.$LzTextSprite$setFontSize($0);
...
LzInputTextSprite.prototype.setFontStyle = function ($0) {
    this.$LzTextSprite$setFontStyle($0);
...
LzInputTextSprite.prototype.setFontName = function ($0) {
    this.$LzTextSprite$setFontName($0);
...
LzInputTextSprite.prototype.setWidth = function ($0) {
    if ($0 == null || $0 < 0 || isNaN($0)) return;
    var $1 = this.$LzTextSprite$setWidth($0);
    if ($1 == null) return;
    if (this.quirks.fix_clickable && $1 !== null) {
        $1 = this.CSSDimension($1);
        if ($1 !== this.__iwidthcss) {
            this.__iwidthcss = $1;
...
LzInputTextSprite.prototype.setHeight = function ($0) {
    if ($0 == null || $0 < 0 || isNaN($0)) return;
    var $1 = this.$LzTextSprite$setHeight($0);
    if ($1 == null) return;
    if (this.quirks.fix_clickable && $1 !== null) {
        $1 = this.CSSDimension($1);
        if ($1 !== this.__iheightcss) {
            this.__iheightcss = $1;
...
LzInputTextSprite.prototype.setColor = function ($0) {
    ...
    this.color = $0;
    this.__LzInputDiv.style.color = LzColorUtils.inttohex($0)
};
...
LzInputTextSprite.prototype.setTextColor = function ($0) {
    if (this.textcolor === $0) return;
    this.textcolor = $0;
    this.scrolldiv.style.color = LzColorUtils.inttohex($0)
};
...
var LzXMLParser = {
    parseXML: function ($0, $1, $2) {
        try {
            var $3 = new DOMParser();
            var $4 = $3.parseFromString($0, "text/xml");
            var $5 = this.getParserError($4);
            if ($5) {
                throw new Error($5)
            } else {
                return $4.firstChild
    ...
    getParserError: function ($0) {
        var $1 = lz.embed.browser;
        if ($1.isIE && $1.version < 9) {
    ...
    __checkFirefox: function ($0) {
        var $1 = $0.documentElement;
        if ($1 && $1.nodeName == "parsererror") {
            var $2 = $1.firstChild.nodeValue;
            return $2.match(".*")[0]
        }
    },
    __checkSafari: function ($0) {
        var $1 = $0.documentElement;
        if ($1 instanceof HTMLElement) {
            ($1 = $1.firstChild) && ($1 = $1.firstChild)
        } else {
            $1 = $1.firstChild
        };
        if ($1 && $1.nodeName == "parsererror") {
            var $2 = $1.childNodes[1].textContent;
            return $2.match("[^:]*: (.*)")[1]
        }
    }
};
(function () {
    if (typeof DOMParser == "undefined") {
        DOMParser = function () {};
        DOMParser.prototype.parseFromString = function ($0, $1) {
            if (typeof window.ActiveXObject != "undefined") {
                var $2 = ["Msxml2.DOMDocument.6.0", "Msxml2.DOMDocument.3.0", "MSXML.DomDocument"];
                var $3 = null;
                for (var $4 = 0; $4 < $2.length; $4++) {
                    try {
                        $3 = new ActiveXObject($2[$4]);
                        break
                    } catch ($5) {}
                };
                $3.loadXML($0);
                ...
                $6.open("GET", "data:" + $1 + ";charset=utf-8," + encodeURIComponent($0), false);
                if ($6.overrideMimeType) {
                    $6.overrideMimeType($1)
                };
                $6.send(null);
                return $6.responseXML
            }
        }
    }
})();
var LzXMLTranslator = {
    ...
    copyXML: function ($0, $1, $2) {
        var $3 = this.copyBrowserXML($0, true, $1, $2);
        if ($3 instanceof LzDataElement) {
            return $3
        } else {
            return null
        }
    ...
    copyBrowserNode: function ($0, $1, $2, $3) {
        ...
        if ($4 == 3 || $4 == 4) {
            var $5 = $0.nodeValue;
            if (!($1 && this.whitespacePat.test($5))) {
                if ($2) {
            ...
            var $6 = !$3 && ($0.localName || $0.baseName) || $0.nodeName;
            var $7 = {};
            var $8 = $0.attributes;
            if ($8) {
                for (var $9 = 0, $a = $8.length; $9 < $a; $9++) {
                    var $b = $8[$9];
                    if ($b) {
                        var $c = !$3 && ($b.localName || $b.baseName) || $b.name;
                        $7[$c] = $b.value
                    }
                }
            };
            var $d = new LzDataElement($6);
            $d.attributes = $7;
            return $d
        }
    },
    copyBrowserXML: function ($0, $1, $2, $3) {
        var $4 = new LzDataElement(null);
        if (!$0.firstChild) {
            return $4.appendChild(this.copyBrowserNode($0, $1, $2, $3))
        };
        var $5 = this.whitespacePat;
        var $6 = this.stringTrimPat;
        var $7 = $4;
        var $8, $9 = $0;
        for (;;) {
            var $a = $9.nodeType;
            if ($a == 3 || $a == 4) {
                ...
                if (!($1 && $5.test($b))) {
                    ...
                    var $c = $7.childNodes;
                    var $d = $c[$c.length - 1];
                    if ($d instanceof LzDataText) {
                        $d.data += $b
                    } else {
                        var $e = new LzDataText($b);
                        $e.parentNode = $7;
                        $e.ownerDocument = $4;
                        $e.__LZo = $c.push($e) - 1
                    }
                ...
                var $f = !$3 && ($9.localName || $9.baseName) || $9.nodeName;
                var $g = {};
                var $h = $9.attributes;
                if ($h) {
                    for (var $i = 0, $j = $h.length; $i < $j; $i++) {
                        var $k = $h[$i];
                        if ($k) {
                            var $l = !$3 && ($k.localName || $k.baseName) || $k.name;
                            $g[$l] = $k.value
                        }
                    }
                };
                var $e = new LzDataElement($f);
                $e.attributes = $g;
                $e.parentNode = $7;
                $e.ownerDocument = $4;
                $e.__LZo = $7.childNodes.push($e) - 1;
                if ($8 = $9.firstChild) {
                    $7 = $e;
                    $9 = $8;
                    continue
...
LzHTTPLoader.prototype.loadSuccess = function ($0, $1) {};
LzHTTPLoader.prototype.loadError = function ($0, $1) {};
LzHTTPLoader.prototype.loadTimeout = function ($0, $1) {};
LzHTTPLoader.prototype.loadContent = function ($0, $1) {
...
LzHTTPLoader.prototype.translateXML = function () {
    var $0 = this.responseXML;
    if ($0 == null || $0.childNodes.length == 0 || lz.embed.browser.isFirefox && LzXMLParser.getParserError($0) != null) {
        ...
        if ($1 != null) {
            var $5 = LzXMLTranslator.copyXML($1, this.options.trimwhitespace, this.options.nsprefix);
            this.loadSuccess(this, $5)
        } else {
            this.loadError(this, null)
        }
    }
...
LzHTTPLoader.prototype.setTimeout = function ($0) {
    this.timeout = $0
};
...
LzHTTPLoader.prototype.__setRequestHeaders = function ($0, $1) {
    if ($1 != null) {
        for (var $2 in $1) {
            var $3 = $1[$2];
            $0.setRequestHeader($2, $3)
        }
    }
};
LzHTTPLoader.prototype.__getAllResponseHeaders = function ($0) {
    var $1 = new RegExp("^([-\\w]+):\\s*(\\S(?:.*\\S)?)\\s*$", "mg");
    var $2 = $0.getAllResponseHeaders();
    var $3 = {};
    var $4;
    while (($4 = $1.exec($2)) != null) {
        $3[$4[1]] = $4[2]
    };
    return $3
};
LzHTTPLoader.prototype.loadXMLDoc = function ($0, $1, $2, $3, $4) {
    if (this.req) {
        ...
        this.req.onreadystatechange = function () {
            ...
            if ($0.readyState == 4) {
                if (self.__timeout) {
                    ...
                    if ($1 == 200 || $1 == 304) {
                        self.responseXML = $0.responseXML;
                        self.responseText = $0.responseText;
                        self.responseHeaders = self.__getAllResponseHeaders($0);
        ...
        this.__setRequestHeaders(this.req, $2);
...
LzHTTPLoader.prototype.checkIfCORS = function () {
    var $0 = new(lz.URL)(this.requesturl);
    if (this.options.proxied === "true" || $0.host === null && $0.port === null) {
        return false
    };
    var $1 = new RegExp("//(www.)?(.[^/:]+)"),
        $2 = $0.protocol == "https",
        $3 = $0.port;
    if ($3 == null) {
        if ($2) {
    ...
    this.iscors = $0.host != document.location.hostname || document.location.port != $3;
    return this.iscors
};
...
var LzScreenKernel = {
    ...
    __resizeEvent: function () {
        var $0 = LzSprite.__rootSpriteContainer;
        LzScreenKernel.width = $0.offsetWidth;
        LzScreenKernel.height = $0.offsetHeight;
...
Class.make("LzContextMenuKernel", ["$lzsc$initialize", function ($0) {
    ...
    var $1 = this.owner;
    var $2 = this._delegate;
    if ($2 != null) $2.execute($1);
    if ($1.onmenuopen.ready) $1.onmenuopen.sendEvent($1);
    var $3 = [];
    var $4 = $1._filteredItems($0);
    this.kernelItems = [];
    var $5 = {};
    for (var $6 = 0; $6 < $4.length; $6++) {
        ...
        var $8 = $7.cmenuitem;
        var $9 = $8.caption;
        if ($8.visible != true || ($9 in $5)) {
            continue
        };
        $5[$9] = true;
        this.kernelItems[$6] = $7;
        if ($8.separatorBefore) {
            $3.push({
                type: "separator"
            })
        };
    ...
    var $a = LzContextMenuKernel.lzcontextmenu || LzContextMenuKernel.__create();
    $a.setItems($3);
    $a.show()
}, "__hide", function () {
    LzMouseKernel.__showncontextmenu = null
}, "__select", function ($0) {
    var $1 = this.kernelItems;
    if ($1 && $1[$0]) $1[$0].__select()
}], null, ["lzcontextmenu", null, "__create", function () {
    var $0 = LzContextMenuKernel.lzcontextmenu;
    if (!$0) {
...
(function () {
    if (LzSprite.quirks.ie_timer_closure) {
        (function ($0) {
            window.setTimeout = $0(window.setTimeout);
            window.setInterval = $0(window.setInterval)
        })(function (f) {
            return (function (c, $0) {
...
LzFontManager.fonts = {};
LzFontManager.addFont = function ($0, $1, $2, $3, $4) {
    var $5 = {
        name: $0,
        style: $1,
        weight: $2,
...
LzFontManager.generateCSS = function () {
    ...
    for (var $2 in $0) {
        var $3 = $0[$2];
        var $4 = this.getURL($3);
        var $2 = $4.lastIndexOf(".ttf");
        var $5 = $4;
        var $6 = $4.substring(0, $2) + ".eot";
        var $7 = $4.substring(0, $2) + ".woff";
        $1 += "@font-face{" + "font-family:" + $3.name + ";" + "src:url(" + $6 + ");" + 'src:local("' + $3.name + '"),' + "url(" + $7 + ') format("woff"),' + "url(" + $6 + ') format("embedded-opentype"),' + "url(" + $5 + ') format("truetype");' + "font-weight:" + $3.weight + ";" + "font-style:" + $3.style + ";" + "}"
    };
    return $1
};
...
LzFontManager.__fontloadstate = {
    counter: 0
};
LzFontManager.__fontloadcallbacks = {};
LzFontManager.isFontLoaded = function ($0, $1, $2, $3) {
    var $4 = this.fonts[$1 + "_" + $2 + "_" + $3];
    if (!$4) return true;
    var $5 = this.getURL($4);
    var $6 = this.__fontloadstate[$5];
    if ($6) {
        var $7 = $6.state;
        if ($7 >= 2) {
            return true
        ...
        var $8 = "font-family:" + $1 + ";font-style:" + $2 + ";font-weight:" + $3 + ";width:auto;height:auto;";
        var $9 = this.__createMeasureDiv("lzswftext", $8);
        this.__setTextContent($9, "div", 'Yq_gy"9;ABCDEFGHIJKLMNOPQRSTUVWXYZ123456789-=abcdefghijklmnopqrstuvwxyz');
        $9.style.display = "inline";
        var $a = $9.clientWidth;
        var $b = $9.clientHeight;
        $9.style.display = "none";
        var $6 = {
            state: 1,
            timer: new Date().valueOf()
        };
        this.__fontloadstate[$5] = $6;
        this.__fontloadstate.counter++;
        var $c = lz.BrowserUtils.getcallbackfunc(LzFontManager, "__measurefontdiv", [$9, $a, $b, $5]);
        $6.TID = setInterval($c, Math.random() * 20 + 30)
    };
    this.__fontloadcallbacks[$0.uid] = $0
};
LzFontManager.fontloadtimeout = 15000;
LzFontManager.__measurefontdiv = function ($0, $1, $2, $3) {
    $0.style.display = "inline";
    var $4 = $0.clientWidth;
    var $5 = $0.clientHeight;
    $0.style.display = "none";
    var $6 = this.__fontloadstate[$3];
    if ($4 == $1 && $5 == $2) {
        var $7 = new Date().valueOf() - $6.timer;
        if ($7 < this.fontloadtimeout) {
            return
        };
        $6.state = 3
    } else {
    ...
    var $8 = this.__fontloadcallbacks;
    for (var $9 in $8) {
        var $a = $8[$9];
        if ($a) {
            $a.__fontLoaded()
...
LzFontManager.__createContainerDiv = function () {
    var $0 = document.createElement("div");
    $0.setAttribute("id", "lzTextSizeCache");
...
LzFontManager.getSize = function ($0, $1, $2, $3, $4) {
    ...
    var $9 = $6[$8];
    if (!$9) {
        var $9 = this.__createMeasureDiv($1, $2);
        $6[$8] = $9
    };
    this.__setTextContent($9, $3, $4);
    $9.style.display = "inline";
    $7[$0] = $0 == "width" ? $9.clientWidth : $9.clientHeight;
    $9.style.display = "none";
    return $7
};
LzFontManager.__createMeasureDiv = function ($0, $1) {
    var $2 = "div";
    var $3 = this.__sizecache;
    if (LzSprite.prototype.quirks["text_measurement_use_insertadjacenthtml"]) {
        var $4 = "<" + $2 + ' id="testSpan' + $3.counter + '"';
        $4 += ' class="' + $0 + '"';
        $4 += ' style="' + $1 + '">';
        $4 += "</" + $2 + ">";
        this.__rootdiv.insertAdjacentHTML("beforeEnd", $4);
        var $5 = document.all["testSpan" + $3.counter];
        if (LzSprite.prototype.quirks.ie_leak_prevention) {
            LzTextSprite.prototype.__divstocleanup.push($5)
        }
    } else {
        var $5 = document.createElement($2);
        $5.setAttribute("class", $0);
        $5.setAttribute("style", $1);
        this.__rootdiv.appendChild($5)
    };
    $3.counter++;
    return $5
};
...
Class.make("LzView", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["construct"] || this.nextMethod(arguments.callee, "construct")).call(this, $0 ? $0 : canvas, $1);
    ...
    if (this.capabilities.colortransform) {
        this.$lzc$set_colortransform({
            redMultiplier: $0.ra != null ? $0.ra / 100 : 1,
            redOffset: $0.rb,
            greenMultiplier: $0.ga != null ? $0.ga / 100 : 1,
            greenOffset: $0.gb,
            blueMultiplier: $0.ba != null ? $0.ba / 100 : 1,
            blueOffset: $0.bb,
            alphaMultiplier: $0.aa != null ? $0.aa / 100 : 1,
            alphaOffset: $0.ab
        })
    }
...
Class.make("LzTextscrollEvent", ["__senderscope", void 0, "$lzsc$initialize", function ($0, $1, $2) {
    switch (arguments.length) {
        case 2:
            $2 = null;
    ...
    if (this.__senderscope) {
        var $1 = this.__senderscope;
        if ($0) {
            $1.__scrollEventListeners++
        } else {
            $1.__scrollEventListeners--
        };
        var $2 = $1.__scrollEventListeners > 0 || $1.__userscrollevents;
        if ($2 != $1.scrollevents) {
...
Class.make("LzTextlinkEvent", ["__senderscope", void 0, "$lzsc$initialize", function ($0, $1, $2) {
    switch (arguments.length) {
        case 2:
            $2 = null;
...
Class.make("LzText", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 0:
            $0 = null;
        case 1:
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzc$set_clip"] || this.nextMethod(arguments.callee, "$lzc$set_clip")).call(this, $0);
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzc$set_width"] || this.nextMethod(arguments.callee, "$lzc$set_width")).call(this, $0);
    ...
    switch ($0) {
        case "scrollTop":
            this.updateAttribute("yscroll", -$1);
            this.updateLineAttribute("scroll", $1);
            break;
        case "scrollLeft":
            this.updateAttribute("xscroll", -$1);
            this.updateAttribute("hscroll", $1);
            break;
        case "scrollHeight":
            this.updateAttribute("scrollheight", $1);
            this.updateLineAttribute("maxscroll", Math.max(0, $1 - this.height));
            break;
        case "scrollWidth":
            this.updateAttribute("scrollwidth", $1);
            this.updateAttribute("maxhscroll", Math.max(0, $1 - this.width));
            break;
        case "lineHeight":
            this.updateAttribute("lineheight", $1);
            if (this.inited) {
    ...
    if ($0 == "plain" || $0 == "bold" || $0 == "italic" || $0 == "bolditalic" || $0 == "bold italic") {
        ...
        (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzc$set_fontstyle"] || this.nextMethod(arguments.callee, "$lzc$set_fontstyle")).call(this, $0);
    ...
    var $1 = this.font;
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzc$set_font"] || this.nextMethod(arguments.callee, "$lzc$set_font")).call(this, $0);
    ...
    if ($0 <= 0 || isNaN($0)) {
        ...
        var $1 = this.fontsize;
        (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzc$set_fontsize"] || this.nextMethod(arguments.callee, "$lzc$set_fontsize")).call(this, $0);
    ...
    var $1 = this.fgcolor;
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzc$set_fgcolor"] || this.nextMethod(arguments.callee, "$lzc$set_fgcolor")).call(this, $0);
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzc$set_hasdirectionallayout"] || this.nextMethod(arguments.callee, "$lzc$set_hasdirectionallayout")).call(this, $0)
}, "__cascadeattrs", {
    font: true,
    fontsize: true,
    fontstyle: true,
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["construct"] || this.nextMethod(arguments.callee, "construct")).call(this, $0, $1);
    var $2 = {
        hassetheight: this.hassetheight,
        height: this.height
    };
    var $3 = [];
    ...
    if ($3.length > 0) {
        var $6 = this.searchParentAttrs($3);
        for (var $5 in $6) {
            var $7 = $6[$5];
            this[$5] = $2[$5] = $7[$5];
...
Class.make("LzInputText", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 0:
            $0 = null;
        case 1:
    ...
    if ($0 == "onfocus") {
        ...
        var $3 = this.isprite.getText();
        var $4 = this.text !== $3;
        this.text = $3;
        if (this.multiline && !this.hassetheight) {
            var $5 = this.isprite.getTextfieldHeight();
            if (this.height != $5) {
                this.updateHeight($5)
            }
        };
        if ($4 && this.ontext.ready) this.ontext.sendEvent(this.text)
    } else if ($0 == "onblur") {
        this._focused = false;
        if (lz.Focus.getFocus() === this) {
            lz.Focus.clearFocus()
    ...
    this._selectable = $0;
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzc$set_selectable"] || this.nextMethod(arguments.callee, "$lzc$set_selectable")).call(this, this._allowselectable ? $0 : false)
...
Class.make("LzViewLinkage", ["xscale", 1, "yscale", 1, "xoffset", 0, "yoffset", 0, "uplinkArray", null, "downlinkArray", null, "$lzsc$initialize", function ($0, $1) {
    if ($0 === $1) {
        return
    };
    var $2 = this.uplinkArray = [];
    var $3 = $0;
    do {
        $3 = $3.immediateparent;
        $2.push($3)
    } while ($3 !== canvas);
    var $4 = this.downlinkArray = [];
    var $3 = $1;
    do {
        $3 = $3.immediateparent;
        $4.push($3)
    ...
    var $2 = $0 + "offset";
    var $3 = "__" + $2;
    var $4 = this.uplinkArray;
    var $5 = this.downlinkArray;
    var $6 = 1;
    var $7 = 0;
    if ($4) {
        var $8 = $4.length - 1;
...
Class.make("LzCanvas", ["updatePercentCreatedEnabled", true, "_lzinitialsubviews", [], "totalnodes", void 0, "framerate", 30, "onframerate", LzDeclaredEvent, "creatednodes", void 0, "__LZproxied", void 0, "embedfonts", void 0, "lpsbuild", void 0, "lpsbuilddate", void 0, "appbuilddate", void 0, "runtime", void 0, "allowfullscreen", void 0, "fullscreen", void 0, "onfullscreen", LzDeclaredEvent, "__LZmouseupDel", void 0, "__LZmousedownDel", void 0, "__LZmousemoveDel", void 0, "__LZDefaultCanvasMenu", void 0, "screenorientation", "landscape", "onscreenorientation", LzDeclaredEvent, "httpdataprovider", null, "defaultdataprovider", null, "$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    if (LzMouseKernel.__lastMouseDown) {
        var $1 = canvas.getMouse("x");
        var $2 = canvas.getMouse("y");
        if ($1 < 0 || $1 > canvas.width || $2 < 0 || $2 > canvas.height) {
            LzMouseKernel.__lastMouseDown.__globalmouseup({
                type: "mouseout"
            })
        }
    }
    ...
    var $0 = new LzContextMenuItem("About OpenLaszlo...", new LzDelegate(this, "__LZdefaultMenuItemHandler"));
    this.__LZDefaultCanvasMenu.addItem($0);
    if (this.proxied) {
        var $1 = new LzContextMenuItem("View Source", new LzDelegate(this, "__LZviewSourceMenuItemHandler"));
    ...
    canvas.initiatorAddNode({
        attrs: {
            libname: $0
        },
        "class": LzLibraryCleanup
    }, 1);
    canvas.initDone()
...
var canvas;
Class.make("LzScript", ["src", void 0, "$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 0:
            $0 = null;
        case 1:
...
Class.make("LzAnimatorGroup", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 0:
            $0 = null;
        case 1:
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["construct"] || this.nextMethod(arguments.callee, "construct")).call(this, $0, $1);
    var $2 = this.immediateparent;
    if (LzAnimatorGroup["$lzsc$isa"] ? LzAnimatorGroup.$lzsc$isa($2) : $2 instanceof LzAnimatorGroup) {
    ...
    for (var $0 = this.animators.length - 1; $0 >= 0; $0--) {
...
Class.make("LzAnimator", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 0:
            $0 = null;
        case 1:
    ...
    this.primary_K = 1;
    var $3 = 1 * (this.beginPole - $1) * ($0 - this.endPole);
    var $4 = 1 * (this.beginPole - $0) * ($1 - this.endPole);
    ...
    var $1 = this.target.__animatedAttributes;
    ...
    this.crepeat = this.repeat;
    var $0 = this.target;
    var $1 = this.attribute;
    var $2 = $0.__animatedAttributes;
    if ($2 == null) {
    ...
    var $1 = this.currentValue;
    var $2 = this.endPole;
    var $3 = this.beginPole;
    var $4 = Math.exp($0 * 1 / this.duration * Math.log(this.primary_K));
    if ($4 != 1) {
        var $5 = $3 * $2 * (1 - $4);
        var $6 = $2 - $4 * $3;
        if ($6 != 0) $1 = $5 / $6
...
Class.make("LzContextMenu", ["onmenuopen", LzDeclaredEvent, "kernel", null, "items", null, "$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 0:
            $0 = null;
        case 1:
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this, (LzNode["$lzsc$isa"] ? LzNode.$lzsc$isa($0) : $0 instanceof LzNode) ? $0 : null, (LzNode["$lzsc$isa"] ? LzNode.$lzsc$isa($0) : $0 instanceof LzNode) ? $1 : {
        delegate: $0
    }, $2, $3)
}, "construct", function ($0, $1) {
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["construct"] || this.nextMethod(arguments.callee, "construct")).call(this, $0, $1);
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["init"] || this.nextMethod(arguments.callee, "init")).call(this);
    var $0 = this.immediateparent;
    if ($0 && (LzView["$lzsc$isa"] ? LzView.$lzsc$isa($0) : $0 instanceof LzView)) {
    ...
    var $2 = new LzContextMenuItem($0, $1);
    return $2
...
Class.make("LzContextMenuItem", ["onselect", LzDeclaredEvent, "kernel", null, "$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 1:
            $1 = null;
        case 2:
    ...
    var $4 = this.immediateparent;
    if ($4 && (LzContextMenu["$lzsc$isa"] ? LzContextMenu.$lzsc$isa($4) : $4 instanceof LzContextMenu)) {
        $4.addItem(this)
    }
}, "delegate", void 0, "$lzc$set_delegate", function ($0) {
    this.delegate = $0;
...
Class.make("LzFont", ["style", void 0, "name", void 0, "height", void 0, "ascent", void 0, "descent", void 0, "advancetable", void 0, "lsbtable", void 0, "rsbtable", void 0, "fontobject", void 0, "$lzsc$initialize", function ($0, $1, $2) {
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this);
    this.name = $0.name;
    this.style = $2;
    this.fontobject = $0;
...
lz.Font = LzFont;
Class.make("LzState", ["heldArgs", void 0, "releasedconstraints", void 0, "appliedChildren", void 0, "applyOnInit", false, "__LZpool", null, "__LZstateconstraintdelegates", void 0, "$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 2:
            $2 = null;
        case 3:
    ...
    for (var $5 in $2) {
        var $6 = $2[$5];
        if (LzOnceExpr["$lzsc$isa"] ? LzOnceExpr.$lzsc$isa($6) : $6 instanceof LzOnceExpr) {
            var $f = $6.methodName;
            if ($f in $3) {
                $2[$f] = $3[$f];
                delete $3[$f]
    ...
    if ($h != null) {
        for (var $b = 0, $c = $h.length; $b < $c; $b += 2) {
            ...
            var $k = null;
            if (Function["$lzsc$isa"] ? Function.$lzsc$isa($3[$f]) : $3[$f] instanceof Function) {
                $3[$j] = $3[$f];
                delete $3[$f]
            ...
            if (LzAlwaysExpr["$lzsc$isa"] ? LzAlwaysExpr.$lzsc$isa($i) : $i instanceof LzAlwaysExpr) {
                var $g = $i.dependenciesName;
                var $l = $g + this.__LZUID;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa($3[$g]) : $3[$g] instanceof Function) {
                    $3[$l] = $3[$g];
                    delete $3[$g]
...
Class.make("LzURL", ["protocol", null, "host", null, "port", null, "path", null, "file", null, "query", null, "fragment", null, "_parsed", null, "$lzsc$initialize", function ($0) {
    switch (arguments.length) {
        case 0:
            $0 = null;
...
Mixin.make("LzDataElementMixin", ["__LZchangeQ", null, "__LZlocker", null, "nodeName", null, "attributes", null, "insertBefore", function ($0, $1) {
    if ($0 == null) {
        return null
    } else if ($1 == null) {
        return this.appendChild($0)
    } else {
        var $2 = this.__LZgetCO($1);
        if ($2 >= 0) {
            var $3 = $0 === $1;
            if ($0.parentNode != null) {
                if ($0.parentNode === this) {
                    if (!$3) {
                        var $4 = this.__LZremoveChild($0);
                        if ($4 != -1 && $4 < $2) {
                            $2 -= 1
                        }
                    }
    ...
    var $1 = new LzDataElement(this.nodeName, this.attributes);
    if ($0) {
        var $2 = this.childNodes;
        var $3 = [];
    ...
    var $1 = this.__LZlt + this.nodeName;
    var $2 = this.attributes;
    for (var $3 in $2) {
...
Class.make("LzDataElement", ["$lzsc$initialize", function ($0, $1, $2) {
    switch (arguments.length) {
        case 1:
            $1 = null;
        case 2:
    ...
    if (typeof $0 == "object") {
        if ((LzDataElement["$lzsc$isa"] ? LzDataElement.$lzsc$isa($0) : $0 instanceof LzDataElement) || (LzDataText["$lzsc$isa"] ? LzDataText.$lzsc$isa($0) : $0 instanceof LzDataText)) {
            ...
            var $2 = LzDataElement.__LZdateToJSON($0);
            if ($2 != null) {
                $1[0] = new LzDataText($2)
            }
        } else if (Array["$lzsc$isa"] ? Array.$lzsc$isa($0) : $0 instanceof Array) {
            var $3 = $0.__LZtag != null ? $0.__LZtag : "item";
            for (var $4 = 0; $4 < $0.length; $4++) {
                var $5 = LzDataElement.__LZv2E($0[$4]);
    ...
    '"': "&quot;",
    "'": "&apos;"
}, "__LZXMLescape", function ($0) {
    if (typeof $0 != "string") return $0;
    var $1 = LzDataElement.__LZescapechars;
    var $2 = $0.length;
    var $3 = "";
    for (var $4 = 0; $4 < $2; $4++) {
        var $5 = $0.charCodeAt($4);
        if ($5 < 32) {
            $3 += "&#x" + $5.toString(16) + ";"
        } else {
            var $6 = $0.charAt($4);
    ...
    if ($0 != null && $0 != "") {
        ...
        if ($3 != null) {
            var $5 = LzXMLTranslator.copyXML($3, $1, $2);
            return $5
        }
    };
    return null
    ...
    var $1 = LzDataElement.whitespaceChars;
    var $2 = $0.length;
    var $3 = 0;
    var $4 = $2 - 1;
    var $5;
...
Class.make("LzDataText", ["$lzsc$initialize", function ($0) {
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this);
...
Class.make("LzDataRequest", ["requestor", null, "src", null, "timeout", Infinity, "status", null, "rawdata", null, "error", null, "onstatus", LzDeclaredEvent, "$lzsc$initialize", function ($0) {
    switch (arguments.length) {
        case 0:
            $0 = null;
...
Class.make("LzDataProvider", ["$lzsc$initialize", function () {
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this)
}, "doRequest", function ($0) {}, "abortLoadForRequest", function ($0) {}], LzEventable);
...
Class.make("LzHTTPDataProvider", ["__loaders", null, "$lzsc$initialize", function () {
    ...
    var $e = "__lzbc__=" + Math.floor(Math.random() * (-1 >>> 1)).toString(36);
    ...
    if ($2) {
        ...
        var $g = $f.indexOf("?");
        var $h = $f.substring($g + 1, $f.length);
        var $i = $f.substring(0, $g);
        $f = $i + "?" + $e;
        $c = $h
    } else {
    ...
    var $4 = null;
    if ($2) {
        var $5 = $1.childNodes.length > 1 && $1.childNodes[1].childNodes ? $1.childNodes[1].childNodes : null;
        if ($5 != null) {
...
Class.make("LzDataset", ["rawdata", null, "dataprovider", void 0, "multirequest", false, "dataRequest", null, "dataRequestClass", LzHTTPDataRequest, "dsloadDel", null, "errorstring", void 0, "reqOnInitDel", void 0, "secureport", void 0, "proxyurl", null, "onerror", LzDeclaredEvent, "ontimeout", LzDeclaredEvent, "timeout", 60000, "$lzc$set_timeout", function ($0) {
    ...
    if ($0 != null) {
        var $1 = LzDataElement.stringToLzData($0, this.trimwhitespace, this.nsprefix);
        if ($1 != null) {
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzc$set_name"] || this.nextMethod(arguments.callee, "$lzc$set_name")).call(this, $0);
    if ($0 != null) {
        this.nodeName = $0;
        if (this.oncanvas) {
            canvas[$0] = this
...
Class.make("__LzHttpDatasetPoolClass", ["_uid", 0, "_p", [], "get", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 0:
            $0 = null;
        case 1:
    ...
    if (this._p.length > 0) {
        ...
        $4 = new LzDataset(null, {
            name: "LzHttpDatasetPool" + this._uid,
            type: "http",
            acceptencodings: $3
        });
        this._uid++
...
Class.make("LzDatapointer", ["$lzc$set_xpath", function ($0) {
    this.setXPath($0)
    ...
    var $0 = this.context;
    if ($0 == null || $0 === this || !(LzDatapointer["$lzsc$isa"] ? LzDatapointer.$lzsc$isa($0) : $0 instanceof LzDatapointer)) {
        return 1
    } else {
    ...
    if (this.__LZpchanged) {
        ...
        if (this.onDocumentChange.ready) this.onDocumentChange.sendEvent({
            who: this.p,
            type: 2,
            what: "context"
        })
    ...
    if ($0) {
        var $2 = $0;
        for (var $3 = 0; $3 < $2.length && $1 != null; $3++) {
            $1 = $1[$2[$3]]
        };
    ...
    if ($0.selectors != null) {
        var $3 = $0.selectors.length;
        for (var $4 = $2; $4 < $3; $4++) {
            var $5 = $0.selectors[$4];
            var $6 = LzDatapointer.pathSymbols[$5] || 0;
            var $7 = $0.selectors[$4 + 1];
            if ($7 && !(String["$lzsc$isa"] ? String.$lzsc$isa($7) : $7 instanceof String) && $7["pred"] == "range") {
                var $8 = $0.selectors[++$4]
            } else {
                var $8 = null
            };
            var $9 = null;
            if ((Object["$lzsc$isa"] ? Object.$lzsc$isa($5) : $5 instanceof Object) && ("pred" in $5) && null != $5.pred) {
                if ($5.pred == "hasattr") {
    ...
    var $3 = new LzDataElement($1, $0);
    $2.appendChild($3);
    return $3
}, "makeTextNode", function ($0, $1) {
    var $2 = new LzDataText($0);
    $1.appendChild($2);
    return $2
}, "serialize", function () {
    if (this.p == null) {
...
}], LzNode, ["tagname", "datapointer", "__LZCSSTagSelectors", ["datapointer", "node"], "attributes", {
...
Class.make("LzParam", ["d", null, "delimiter", "&", "$lzc$set_delimiter", function ($0) {
    this.setDelimiter($0)
    ...
    var $1 = this.delimiter;
    this.delimiter = $0;
    return $1
}, "setSeparator", function ($0) {
    var $1 = this.separator;
    this.separator = $0;
    return $1
}, "toString", function () {
    return this.serialize()
    ...
    var $0 = $0 == null ? this.separator : $0;
    var $3 = $1 == null ? this.delimiter : $1;
    var $4 = "";
    var $5 = false;
    for (var $6 in this.d) {
        var $7 = this.d[$6];
...
lz.Param = LzParam;
Class.make("LzParsedPath", ["path", null, "selectors", null, "context", null, "dsetname", null, "dsrcname", null, "islocaldata", null, "operator", null, "aggOperator", null, "hasAttrOper", false, "hasOpSelector", false, "hasDotDot", false, "getContext", function ($0) {
                ...
                for (var $h = 1; $h < $f.length; $h++) {
                    ...
                    if (LzParsedPath.trim($i).charAt(0) == "@") {
                        ...
                        if ($j.length > 0) {
                            ...
                            $k = {
                                pred: "attrval",
                                attr: LzParsedPath.trim($l),
                                val: LzParsedPath.trim($m)
                            }
                        } else {
                            $k = {
                                pred: "hasattr",
...
Class.make("AnonDatasetGenerator", ["pp", null, "__LZdepChildren", null, "onDocumentChange", LzDeclaredEvent, "onerror", LzDeclaredEvent, "ontimeout", LzDeclaredEvent, "noncontext", true, "$lzsc$initialize", function ($0) {
    ...
    var $0 = new LzDataset(null, {
        name: null
    });
    var $1 = this.pp.selectors;
    if ($1 != null) {
        var $2 = $0.getPointer();
        for (var $3 = 0; $3 < $1.length; $3++) {
            if ($1[$3] == "/") continue;
...
Class.make("LzDatapath", ["datacontrolsvisibility", true, "$lzc$set_datacontrolsvisibility", function ($0) {
    ...
    if (this.__LZtakeDPSlot) {
        ...
        var $2 = this.immediateparent.searchParents("datapath").datapath;
        if ($2 != null) {
            var $3 = $2.__LZdepChildren;
            if ($3 != null) {
                $2.__LZdepChildren = [];
                for (var $4 = $3.length - 1; $4 >= 0; $4--) {
                    var $5 = $3[$4];
                    if ($5 !== this && !(LzDataAttrBind["$lzsc$isa"] ? LzDataAttrBind.$lzsc$isa($5) : $5 instanceof LzDataAttrBind) && $5.immediateparent != this.immediateparent && $5.immediateparent.childOf(this.immediateparent)) {
    ...
    this.storednodes = $0;
    var $2 = new $1(this, this._instanceAttrs);
    this.storednodes = null;
    return $2
}, "setNodes", function ($0) {
    var $1 = this.__LZHandleMultiNodes($0);
    if (!$1) $1 = this;
    $1.__LZsetTracking(null);
    if ($0) {
        for (var $2 = 0; $2 < $0.length; $2++) {
            var $3 = $0[$2];
            var $4 = $3.ownerDocument;
    ...
    var $2 = this.__LZpchanged;
    if (!(arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["__LZsendUpdate"] || this.nextMethod(arguments.callee, "__LZsendUpdate")).call(this, $0, $1)) {
        return false
    };
    ...
    var $3 = $0 || $1.data != this.data || this.parsedPath && this.parsedPath.operator == "attributes";
    this.data = this.data == null ? null : this.data;
    $1.data = this.data;
    if ($3) {
        if ($1.ondata.ready) $1.ondata.sendEvent(this.data);
        var $4 = this.parsedPath;
    ...
    this.__LZupdateLocked = true;
    var $0 = this.context;
    if ($0 && !$0.__LZdeleted && (LzDatapath["$lzsc$isa"] ? LzDatapath.$lzsc$isa($0) : $0 instanceof LzDatapath)) {
        var $1 = $0.__LZdepChildren;
        if ($1 != null) {
            for (var $2 = 0; $2 < $1.length; $2++) {
                if ($1[$2] === this) {
                    $1.splice($2, 1);
    ...
    if (!$3.__LZdeleted) {
        ...
        if ($4 != null && $4.length > 0) {
            var $5 = $3.searchParents("datapath").datapath;
            for (var $2 = 0; $2 < $4.length; $2++) {
    ...
    if (this.__LZisclone) {
        ...
        var $0 = this.context;
        if (this.p == $0.getContext() && (LzDatapointer["$lzsc$isa"] ? LzDatapointer.$lzsc$isa($0) : $0 instanceof LzDatapointer)) {
...
Class.make("LzReplicationManager", ["asyncnew", true, "initialnodes", void 0, "clonePool", void 0, "cloneClass", void 0, "cloneParent", void 0, "cloneAttrs", void 0, "cloneChildren", void 0, "hasdata", void 0, "orderpath", void 0, "comparator", void 0, "__LZxpathconstr", null, "__LZxpathdepend", null, "visible", true, "__LZpreventXPathUpdate", false, "nodes", void 0, "clones", void 0, "__LZdataoffset", 0, "onnodes", LzDeclaredEvent, "onclones", LzDeclaredEvent, "onvisible", LzDeclaredEvent, "$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["construct"] || this.nextMethod(arguments.callee, "construct")).call(this, $2.parent, $1);
    ...
    var $6 = new LzInheritedHash($2._instanceAttrs);
    $6.datapath = LzNode._ignoreAttribute;
    $6.$datapath = {
        "class": lz.datapath
    };
    $6.$datapath.attrs = {
        datacontrolsvisibility: $0.datacontrolsvisibility,
        __LZmanager: this
    };
    delete $6.id;
    delete $6.name;
    ...
    if ($0.datacontrolsvisibility) {
        ...
        if (!$2.isinited) {
            ...
            if (typeof $7 == "boolean" || (Boolean["$lzsc$isa"] ? Boolean.$lzsc$isa($7) : $7 instanceof Boolean)) {
                this.visible = $7
            } else {
    ...
    if (LzAlwaysExpr["$lzsc$isa"] ? LzAlwaysExpr.$lzsc$isa($8) : $8 instanceof LzAlwaysExpr) {
        var $9 = $8;
        ...
        if (LzAlwaysExpr["$lzsc$isa"] ? LzAlwaysExpr.$lzsc$isa($a) : $a instanceof LzAlwaysExpr) {
            var $b = new LzRefNode(this);
            var $c = $a;
    ...
    var $2 = $0._instanceAttrs;
    if ($2 && ($1 in $2)) {
        return $2[$1]
    } else {
        var $3 = $0["constructor"].attributes;
        if ($3 && ($1 in $3)) {
            return $3[$1]
        }
    };
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["__LZapplyArgs"] || this.nextMethod(arguments.callee, "__LZapplyArgs")).call(this, $0, $1);
    if (this.__LZdeleted) {
        return
    };
    ...
    var $1 = this.parent && this.parent.layouts ? this.parent.layouts : [];
    for (var $2 = 0; $2 < $1.length; ++$2) {
        $1[$2].lock()
    };
    this.hasdata = true;
    ...
    if ($1 < $2) {
        var $3 = $1 + Math.floor(($2 - $1) / 2);
        var $4 = this.mergesort($0, $1, $3);
        var $5 = this.mergesort($0, $3 + 1, $2)
    } else if ($0.length == 0) {
        return []
    } else {
        return [$0[$1]]
    ...
    if ($0 == "descending") {
        ...
        $0 = this.ascDict
    } else if (Function["$lzsc$isa"] ? Function.$lzsc$isa($0) : $0 instanceof Function) {};
    this.comparator = $0;
    ...
    return (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["setXPath"] || this.nextMethod(arguments.callee, "setXPath")).call(this, $0)
    ...
    this.p = this.nodes[0];
    var $1 = (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["__LZcheckChange"] || this.nextMethod(arguments.callee, "__LZcheckChange")).call(this, $0);
    this.p = null;
    if (!$1) {
        var $2 = $0.who;
        var $3 = this.clones;
    ...
    var $1 = $0.immediateparent.subviews;
    for (var $2 = $1.length - 1; $2 >= 0; $2--) {
        if ($1[$2] == $0) {
            $1.splice($2, 1);
            break
    ...
    var $3 = $0.immediateparent.onremovesubview;
...
Class.make("LzRefNode", ["__LZxpathconstr", null, "__LZxpathdepend", null, "xpath", null, "$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 1:
            $1 = null;
        case 2:
...
Class.make("LzDataAttrBind", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this, $0);
    this.type = $3;
    this.setAttr = $1;
    this.pathparent = $0;
    ...
    var $2 = this.__LZpchanged;
    var $3 = (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["__LZsendUpdate"] || this.nextMethod(arguments.callee, "__LZsendUpdate")).call(this, $0, $1);
    if ($3) {
        var $4 = this.data;
        var $5 = this.node;
        var $6 = this.setAttr;
    ...
    if (this.__LZdeleted) return;
    var $0 = this.pathparent.__LZdepChildren;
    if ($0 != null) {
...
Class.make("LzLazyReplicationManager", ["sizeAxis", void 0, "cloneimmediateparent", void 0, "updateDel", void 0, "__LZoldnodelen", void 0, "viewsize", 0, "totalsize", 0, "mask", null, "$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 2:
            $2 = null;
        case 3:
    ...
    if ($3) {
        ...
        var $4 = $3.immediateparent.layouts;
        if ($4 != null) {
    ...
    var $2 = this.cloneimmediateparent;
    var $3 = this.nodes;
    var $4 = this.axis;
    var $5 = this.sizeAxis;
    var $6 = this.totalsize;
    if ($3) {
        var $7 = $3.length;
    ...
    var $9 = 0;
    var $a = this.clones.length;
    var $b = $8 - this.__LZdataoffset;
    var $c = $8 * $6 + $2[$4];
    var $d = 0;
    if (typeof $c == "number") {
    ...
    var $2 = (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["getCloneForNode"] || this.nextMethod(arguments.callee, "getCloneForNode")).call(this, $0) || null;
    if (!$2 && !$1) {
        $2 = this.getNewClone();
...
Class.make("LzResizeReplicationManager", ["datasizevar", void 0, "__LZresizeupdating", void 0, "$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 2:
            $2 = null;
        case 3:
    ...
    if ($1) {
        var $2 = this.cloneManager;
        var $3 = $2.datasizevar;
        var $4 = $1.getUserData($3) || $2.viewsize;
        if ($0 != $4) {
            $1.setUserData($3, $0);
    ...
    var $2 = this.nodes != null ? this.nodes.length : 0;
    var $3 = Math.floor(-this.cloneimmediateparent[this.axis]);
    if (0 > $3) $3 = 0;
    var $4 = this.mask[this.sizeAxis];
    var $5 = -1;
    var $6 = this.__LZdataoffset;
    if ($1) {
    ...
    var $n = $c;
    if ($d) $n += this.spacing;
    for (var $e = 0; $e < this.clones.length; $e++) {
...
Class.make("LzColorUtils", null, null, ["__cache", {
    counter: 0
}, "colorfrominternal", function ($0) {
    return $0 & 16777215
    ...
    var $5 = Math.min($1, Math.min($2, $3)),
        $6 = Math.max($1, Math.max($2, $3));
    var $7, $8, $9 = ($6 + $5) / 2;
    if ($6 == $5) {
        $7 = $8 = 0
    } else {
    ...
    switch ($1) {
        ...
        case "rgb":
            $3 = LzColorUtils.rgbafrominternal($0);
            if ($3[3] == 1) {
        ...
        case "hsl":
            $3 = LzColorUtils.hslafrominternal($0);
            if ($3[3] == 1) {
        ...
        case "hsv":
            $3 = LzColorUtils.hsvafrominternal($0);
            if ($3[3] == 1) {
    ...
    $0 = LzColorUtils.hextoint($0);
    var $3 = LzColorUtils.hsvafrominternal($0);
    return $1[$2] = {
        h: $3[0],
        s: $3[1],
        v: $3[2],
...
Class.make("LzBrowserService", ["capabilities", LzSprite.prototype.capabilities, "$lzsc$initialize", function () {
...
}, "postToLps", true, "parsedloadurl", null, "defaultPortNums", {
    http: 80,
    https: 443
}, "getBaseURL", function ($0, $1) {
    switch (arguments.length) {
        case 0:
            $0 = null;
        case 1:
    ...
    if ($0.indexOf(":") > -1) {
        ...
        var $5 = $0.substring($3 + 1, $0.length);
        if ($5.charAt(0) == "/") {
    ...
    var $2 = $0.postbody;
    var $3 = $0.proxyurl;
    var $4 = $0.serverproxyargs;
    var $5;
    if ($4) {
        $5 = {
            url: this.toAbsoluteURL($0.url, $0.secure),
            lzt: $0.service,
            reqtype: $0.httpmethod.toUpperCase()
        };
        for (var $6 in $4) {
            $5[$6] = $4[$6]
        }
        ...
        $5 = {
            ...
            lzt: $0.service,
            reqtype: $0.httpmethod.toUpperCase(),
            sendheaders: $0.sendheaders,
            trimwhitespace: $0.trimwhitespace,
            nsprefix: $0.trimwhitespace,
            timeout: $0.timeout,
            cache: $0.cacheable,
            ccache: $0.ccache
        }
    ...
    for (var $a in $5) {
        ...
        if (typeof $b == "string") {
            ...
            $b = $b.replace(LzDataset.slashPat, "%2F")
        };
        $3 += $9 + $a + "=" + $b;
        $9 = "&"
    };
    return $3
}], null, ["LzBrowser", void 0, "sOptionNameMap", {
    runtime: "lzr",
...
Class.make("LzModeManagerService", ["onmode", LzDeclaredEvent, "__LZlastclick", null, "__LZlastClickTime", 0, "willCall", false, "eventsLocked", false, "modeArray", new Array(), "remotedebug", null, "$lzsc$initialize", function () {
    ...
    if ($0 && (this.modeArray.length == 0 || !this.hasMode($0))) {
        ...
        var $1 = lz.Focus.getFocus();
        if ($1 && !$1.childOf($0)) {
            lz.Focus.clearFocus()
        }
    }
}, "release", function ($0) {
    var $1 = this.modeArray;
    for (var $2 = $1.length - 1; $2 >= 0; $2--) {
        if ($1[$2] === $0) {
    ...
    var $2 = true;
    for (var $3 = this.modeArray.length - 1; $2 && $3 >= 0; --$3) {
        var $4 = this.modeArray[$3];
        if (!$4) {
            continue
        };
        if ($0 && $0.childOf($4)) {
...
Class.make("LzKeysService", ["$lzsc$initialize", function () {
    ...
    control: 17,
    alt: 18
}, "ctrlKey", false, "__keyEvent", function ($0, $1, $2, $3, $4) {
    switch (arguments.length) {
        case 3:
            $3 = false;
        case 4:
    ...
    var $0 = lz.Keys.isKeyDown("shift");
    this.downKeysHash = {};
    this.downKeysArray = [];
    LzKeyboardKernel.__allKeysUp();
    if ($0) {
        lz.Keys.downKeysHash[16] = true
    }
    ...
    var $2 = this.downKeysHash;
    var $3 = this.downKeysArray;
    ...
    if ($4) {
        var $5 = this.keycombos;
        for (var $6 = 0; $6 < $3.length && $5 != null; $6++) {
            $5 = $5[$3[$6]]
        };
        if ($5 != null && ("delegates" in $5)) {
            var $7 = $5.delegates;
            for (var $6 = 0; $6 < $7.length; $6++) {
                $7[$6].execute($3)
            }
        }
    }
}, "gotKeyUp", function ($0) {
    var $1 = this.downKeysHash;
    var $2 = $1[$0];
    delete $1[$0];
    var $3 = this.downKeysArray;
    $3.length = 0;
...
Class.make("LzTrackService", ["__LZreg", new Object(), "__LZactivegroups", null, "__LZtrackDel", null, "__LZmouseupDel", null, "__LZdestroydel", null, "__LZlastmouseup", null, "$lzsc$initialize", function () {
    ...
    var $1 = this.__LZreg[$0];
    if ($1 && !$1.__LZactive) {
        $1.__LZactive = true;
        var $2 = this.__LZactivegroups;
        if ($2.length == 0) {
    ...
    var $1 = this.__LZactivegroups.slice();
    for (var $2 = 0; $2 < $1.length; ++$2) {
        var $3 = $1[$2].__LZlasthit;
        if ($3) {
            var $4 = $3.onmousetrackup;
            if ($4.ready) {
...
Class.make("LzIdleEvent", ["$lzsc$initialize", function ($0, $1, $2) {
    switch (arguments.length) {
        case 2:
            $2 = null;
...
Class.make("LzCSSStyleRule", ["parsed", null, "specificity", 0, "dynamic", false, "properties", void 0, "_lexorder", void 0, "$lzsc$initialize", function ($0, $1, $2, $3) {
    this.parsed = $0;
    if ($0["length"]) {
        var $4 = 0;
        for (var $5 = 0, $6 = $0.length; $5 < $6; $5++) {
    ...
    var $0 = new LzCSSStyleRule(this.parsed, this.properties, "", 0);
...
Class.make("LzCSSStyleClass", ["_idRules", void 0, "_nameRules", void 0, "_attrs", void 0, "_attrRules", void 0, "_tags", void 0, "_tagRules", void 0, "_rules", void 0, "$lzsc$initialize", function () {
    ...
    var $1 = new LzCSSStyleDeclaration();
    $1.setNode($0);
    return $1
    ...
    var $1 = {};
    var $d = {};
    nextrule: for (var $e = $9.length - 1; $e >= 0; $e--) {
        var $f = $9[$e];
        if ($f.dynamic) {
            var $g = $f.parsed;
            var $h = !(!$g["length"]);
    ...
    while ($6) {
        step: switch ($6) {
            case "id":
                $6 = "name";
                var $c = $0["id"];
                if ($c && ($5 = this._idRules[$c])) {
                    break step
                }
            case "name":
                $6 = "attr";
                var $d = $0["name"];
                if ($d && ($5 = this._nameRules[$d])) {
                    break step
                }
            case "attr":
                while ($7 < $8.length) {
        ...
        nextrule: for (var $g = 0, $h = $5.length; $g < $h; $g++) {
            ...
            if (!($6 == "id" || $6 == "name")) {
                var $m = $k["t"];
                if ($m && (!lz[$m] || !(lz[$m]["$lzsc$isa"] ? lz[$m].$lzsc$isa($0) : $0 instanceof lz[$m]))) {
                    continue nextrule
                };
                var $n = $k["a"] ? $k : $k["&"];
                while ($n) {
    ...
    if ($1 && $2 > 0) {
        ...
        while ($2 > 0 && $r) {
            ...
            for (var $g = 0, $h = $s.length; $g < $h && $2 > 0; $g++) {
                var $t = $s[$g];
                var $p = $t.properties;
                for (var $q in $p) {
                    if ($q in $1) {
    ...
    var $4 = $0.parsed;
    var $5 = $1.parsed;
    var $6 = $0._lexorder < $1._lexorder ? 1 : -1;
    ...
    if ($2 && !($3 || $4 || $6)) {
        ...
        var $8 = $1.v;
        if ($8 && $3 == "name") {
            var $9 = this._nameRules[$8];
            if (!$9) {
                $9 = this._nameRules[$8] = []
            };
            $9.push($0)
        } else {
            var $a = this._attrRules[$3];
            if (!$a) {
                this._attrs.push($3);
                $a = this._attrRules[$3] = []
            };
...
Class.make("LzCSSStyleDeclaration", ["$lzsc$initialize", function () {}, "_node", null, "getPropertyValue", function ($0) {
...
Class.make("LzStyleSheet", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    this.type = $3;
    this.disabled = false;
    this.ownerNode = null;
...
Class.make("LzCSSStyleSheet", ["$lzsc$initialize", function ($0, $1, $2, $3, $4, $5) {
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this, $0, $1, $2, $3);
    this.ownerRule = $4;
    this.cssRules = $5
...
Class.make("LzFocusService", ["onfocus", LzDeclaredEvent, "onescapefocus", LzDeclaredEvent, "lastfocus", null, "csel", null, "cseldest", null, "FOCUS_MANUAL", 0, "FOCUS_KEYBOARD", -1, "FOCUS_KEYBOARD_PREV", -2, "FOCUS_MOUSE", 1, "$lzsc$initialize", function () {
    ...
    var $3 = "get" + ($0 == 1 ? "Next" : "Prev") + "Selection";
    var $4 = $1 ? $1[$3]() : null;
    if ($4 == null) {
    ...
    if ($3 || !$1.focustrap && $1.visible) for (var $4 = 0; $4 < $1.subviews.length; $4++) this.accumulateSubviews($0, $1.subviews[$4], $2, false)
...
Class.make("LzTimerService", ["timerList", new Object(), "$lzsc$initialize", function () {
    ...
    var $3 = LzTimeKernel.setTimeout(this.execDelegate, $1, $2);
    $2.id = $3;
    var $4 = $0.__delegateID;
...
Class.make("$lzc$class_lzcontextmenuseparator", ["$8l2c51", function ($0) {
...
Class.make("$lzc$class_lzcontextmenutext", ["$8l2c56", function ($0) {
...
Class.make("$lzc$class_lzcontextmenudisabled", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 0:
            $0 = null;
        case 1:
...
Class.make("$lzc$class_8l2c5f", ["$8l2c5a", function ($0) {
    ...
    LzKernelUtils.rect($0, 2.5, 3.5, this.width - 3, this.height - 3, this.classroot.inset);
    $0.fillStyle = "#000000";
    $0.globalAlpha = 0.2;
    $0.fill();
    $0.beginPath();
    LzKernelUtils.rect($0, 0, 0, this.width - 3, this.height - 3, this.classroot.inset);
    $0.globalAlpha = lz.embed.browser.OS == "Mac" ? 0.97 : 1;
    $0.fillStyle = "#FFFFFF";
    $0.fill();
    $0.globalAlpha = 1;
    $0.strokeStyle = "#CCCCCC";
    $0.stroke();
    for (var $1 in this.parent.__drawnitems) {
        $0.beginPath();
        this.parent.__drawnitems[$1].redraw($0)
    }
...
Class.make("$lzc$class_lzcontextmenu", ["inset", void 0, "__drawnitems", void 0, "__overnow", void 0, "$8l2c59", function ($0) {
    ...
    if ($0.x > canvas.width - this.width) $0.x = canvas.width - this.width;
    if ($0.y > canvas.height - this.height) $0.y = canvas.height - this.height;
    this.bringToFront();
    this.setAttribute("x", $0.x);
    this.setAttribute("y", $0.y);
