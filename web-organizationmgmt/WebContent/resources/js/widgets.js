...
{
    var helpWindow = window.open(location_, '_blank', 'toolbar=no,location=no,directories=no,status=no,scrollbars=yes,menubar=no,resizable=yes,width=560, height=430');
    helpWindow.focus();
    return false;
}
