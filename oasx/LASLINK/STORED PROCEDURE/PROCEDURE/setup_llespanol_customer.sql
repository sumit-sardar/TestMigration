...
Insert into OAS.CUSTOMER_CONFIGURATION
   (CUSTOMER_CONFIGURATION_ID, CUSTOMER_CONFIGURATION_NAME, CUSTOMER_ID, EDITABLE, DEFAULT_VALUE, CREATED_BY, CREATED_DATE_TIME)
 Values
   (seq_customer_configuration_id.nextval, 'LLESPANOL_Customer', cust_id, 'T', 
    'T', 1, TO_DATE('04/12/2011 17:24:57', 'MM/DD/YYYY HH24:MI:SS'));
...
assign_llespanol_demographics(cust_id);

delete from customer_email_config where customer_id = cust_id;
   
assign_llespanol_email_config(cust_id);
 

--org_node_test_catalog for product 7003

delete from org_node_test_catalog where customer_id = cust_id and product_id in (7003);
...
select distinct 
   13217 as test_catalog_id, org.org_node_id, 1 as created_by,
    sysdate as created_date_time, null as updated_by, null as updated_date_time,
    org.customer_id as customer_id, 'AC' as activation_status, 29095 as item_set_id, '7003' as product_id, 
...
where 
 ...
 CUSTOMER_ID, ACTIVATION_STATUS, ITEM_SET_ID, PRODUCT_ID, OVERRIDE_NO_RETAKE, OVERRIDE_FORM_ASSIGNMENT, OVERRIDE_LOGIN_START_DATE,
  LIC_PURCHASED, LIC_RESERVED, LIC_USED, RANDOM_DISTRACTOR_ALLOWABLE) (
select distinct 
   13338 as test_catalog_id, org.org_node_id, 1 as created_by,
    sysdate as created_date_time, null as updated_by, null as updated_date_time,
    org.customer_id as customer_id, 'AC' as activation_status, 29448 as item_set_id, '7003' as product_id, 
    'F' as override_no_retake, null as override_form_assignment, null as override_login_start_date,
    -1 as lic_purchased, -1 as lic_reserved, -1 as lic_used , null as random_distractor_allowable
from 
    org_node org
where 
 ...
 CUSTOMER_ID, ACTIVATION_STATUS, ITEM_SET_ID, PRODUCT_ID, OVERRIDE_NO_RETAKE, OVERRIDE_FORM_ASSIGNMENT, OVERRIDE_LOGIN_START_DATE,
  LIC_PURCHASED, LIC_RESERVED, LIC_USED, RANDOM_DISTRACTOR_ALLOWABLE) (
select distinct 
   13339 as test_catalog_id, org.org_node_id, 1 as created_by,
    sysdate as created_date_time, null as updated_by, null as updated_date_time,
    org.customer_id as customer_id, 'AC' as activation_status, 29457 as item_set_id, '7003' as product_id, 
    'F' as override_no_retake, null as override_form_assignment, null as override_login_start_date,
    -1 as lic_purchased, -1 as lic_reserved, -1 as lic_used , null as random_distractor_allowable
from 
    org_node org
where 
 ...
 CUSTOMER_ID, ACTIVATION_STATUS, ITEM_SET_ID, PRODUCT_ID, OVERRIDE_NO_RETAKE, OVERRIDE_FORM_ASSIGNMENT, OVERRIDE_LOGIN_START_DATE,
  LIC_PURCHASED, LIC_RESERVED, LIC_USED, RANDOM_DISTRACTOR_ALLOWABLE) (
select distinct 
   13341 as test_catalog_id, org.org_node_id, 1 as created_by,
    sysdate as created_date_time, null as updated_by, null as updated_date_time,
    org.customer_id as customer_id, 'AC' as activation_status, 29493 as item_set_id, '7003' as product_id, 
    'F' as override_no_retake, null as override_form_assignment, null as override_login_start_date,
    -1 as lic_purchased, -1 as lic_reserved, -1 as lic_used , null as random_distractor_allowable
from 
    org_node org
where 
 ...
 CUSTOMER_ID, ACTIVATION_STATUS, ITEM_SET_ID, PRODUCT_ID, OVERRIDE_NO_RETAKE, OVERRIDE_FORM_ASSIGNMENT, OVERRIDE_LOGIN_START_DATE,
  LIC_PURCHASED, LIC_RESERVED, LIC_USED, RANDOM_DISTRACTOR_ALLOWABLE) (
select distinct 
   13340 as test_catalog_id, org.org_node_id, 1 as created_by,
    sysdate as created_date_time, null as updated_by, null as updated_date_time,
    org.customer_id as customer_id, 'AC' as activation_status, 29484 as item_set_id, '7003' as product_id, 
    'F' as override_no_retake, null as override_form_assignment, null as override_login_start_date,
    -1 as lic_purchased, -1 as lic_reserved, -1 as lic_used , null as random_distractor_allowable
from 
    org_node org
where 
 ...
 CUSTOMER_ID, ACTIVATION_STATUS, ITEM_SET_ID, PRODUCT_ID, OVERRIDE_NO_RETAKE, OVERRIDE_FORM_ASSIGNMENT, OVERRIDE_LOGIN_START_DATE,
  LIC_PURCHASED, LIC_RESERVED, LIC_USED, RANDOM_DISTRACTOR_ALLOWABLE) (
select distinct 
   13337 as test_catalog_id, org.org_node_id, 1 as created_by,
    sysdate as created_date_time, null as updated_by, null as updated_date_time,
    org.customer_id as customer_id, 'AC' as activation_status, 29439 as item_set_id, '7003' as product_id, 
    'F' as override_no_retake, null as override_form_assignment, null as override_login_start_date,
    -1 as lic_purchased, -1 as lic_reserved, -1 as lic_used , null as random_distractor_allowable
from 
    org_node org
