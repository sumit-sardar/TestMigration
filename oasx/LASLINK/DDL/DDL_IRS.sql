...
alter table LASLINK_CONTENT_AREA_FACT
  add constraint XPKLL_CONTENT_AREA_FACT primary key (FACTID)
/
alter table LASLINK_CONTENT_AREA_FACT
...
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_ELL_DIM_FK7 foreign key (ATTR1ID)
  references ATTR1_DIM (ATTR1ID) on delete set null
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_FORM_DIM_FK7 foreign key (FORMID)
  references FORM_DIM (FORMID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_FRL_DIM_FK7 foreign key (ATTR3ID)
  references ATTR3_DIM (ATTR3ID) on delete set null
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_GENDER_DIM_FK7 foreign key (ATTR4ID)
  references ATTR4_DIM (ATTR4ID) on delete set null
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_GRADE_DIM_FK7 foreign key (GRADEID)
  references GRADE_DIM (GRADEID) on delete set null
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_IEP_DIM_FK7 foreign key (ATTR5ID)
  references ATTR5_DIM (ATTR5ID) on delete set null
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_ITEM_DIM_FK foreign key (ITEMID)
  references ITEM_DIM (ITEMID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_LEP_DIM_FK7 foreign key (ATTR7ID)
  references ATTR7_DIM (ATTR7ID) on delete set null
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_LEVEL_DIM_FK7 foreign key (LEVELID)
  references LEVEL_DIM (LEVELID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_LFS_DIM_FK7 foreign key (ATTR6ID)
  references ATTR6_DIM (ATTR6ID) on delete set null
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_MIGRANT_DIM_FK7 foreign key (ATTR8ID)
  references ATTR8_DIM (ATTR8ID) on delete set null
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_ORG_NODE_DIM_FK foreign key (ORG_NODEID)
  references ORG_NODE_DIM (ORG_NODEID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_OTAADJC_DIM_FK7 foreign key (ATTR15ID)
  references ATTR15_DIM (ATTR15ID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_OTAADJFS_DIM_FK7 foreign key (ATTR16ID)
  references ATTR16_DIM (ATTR16ID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_OTAAP_DIM_FK7 foreign key (ATTR13ID)
  references ATTR13_DIM (ATTR13ID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_OTACAL_DIM_FK7 foreign key (ATTR12ID)
  references ATTR12_DIM (ATTR12ID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_OTASM_DIM_FK7 foreign key (ATTR9ID)
  references ATTR9_DIM (ATTR9ID) on delete set null
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_OTASR_DIM_FK7 foreign key (ATTR11ID)
  references ATTR11_DIM (ATTR11ID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_OTAUT_DIM_FK7 foreign key (ATTR14ID)
  references ATTR14_DIM (ATTR14ID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_RESPONSE_DIM_FK foreign key (RESPONSEID)
  references RESPONSE_DIM (RESPONSEID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_S504_DIM_FK7 foreign key (ATTR10ID)
  references ATTR10_DIM (ATTR10ID) on delete set null
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT2_SESSION_DIM_FK8 foreign key (SESSIONID)
  references SESSION_DIM (SESSIONID)
/
alter table LASLINK_ITEM_FACT
  add constraint LL_ITEM_FACT_CURR_RES_DIM foreign key (CURRENT_RESULTID)
  references CURRENT_RESULT_DIM (CURRENT_RESULTID)
/
