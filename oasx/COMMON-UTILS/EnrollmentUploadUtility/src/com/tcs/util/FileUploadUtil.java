...
public static String getSaveOrUpdateEnrollmentBySubject(String enrollmentTableName){
	...
	public static String getSiteSurveyIdforDsitrct(){
		String sql = "SELECT distinct S_SITE.SITE_SURVEY_ID ,S_SITE.site_type  FROM SITE_SURVEY S_SITE WHERE  S_SITE.CUSTOMER_ID= ? AND S_SITE.SITE_ID = ? AND UPPER(S_SITE.SITE_TYPE) = UPPER ('CORPORATION')";
