...
public class FileUploadUtil {
	...
	public static String getsaveOrUpdateSiteSurveyEnrollMentMergeSQL(
			String[] rowData) {
		String sql = " MERGE INTO site_survey_enrollment ssenrollment USING (select ? AS SITE_SURVEY_ID, ? AS THIRD_GRADE, ? AS  FOURTH_GRADE, ? AS FIFTH_GRADE, ? AS SIXTH_GRADE, ? AS SEVENTH_GRADE,  ? AS EIGHTH_GRADE  from dual) temp ON (ssenrollment.site_survey_id = temp.site_survey_id ) WHEN MATCHED THEN   UPDATE  SET THIRD_GRADE  = temp.THIRD_GRADE,  FOURTH_GRADE  = temp.FOURTH_GRADE,  FIFTH_GRADE   = temp.FIFTH_GRADE,   SIXTH_GRADE   = temp.SIXTH_GRADE,  SEVENTH_GRADE  = temp.SEVENTH_GRADE, EIGHTH_GRADE  = temp.EIGHTH_GRADE, UPDATED_DATE_TIME = SYSDATE WHEN NOT MATCHED  THEN   INSERT     (SITE_SURVEY_ID,      THIRD_GRADE,      FOURTH_GRADE,      FIFTH_GRADE,      SIXTH_GRADE,      SEVENTH_GRADE,      EIGHTH_GRADE) VALUES   ( temp. SITE_SURVEY_ID, temp.THIRD_GRADE,   temp.FOURTH_GRADE,   temp.FIFTH_GRADE,  temp.SIXTH_GRADE, temp.SEVENTH_GRADE,  temp.EIGHTH_GRADE)";
