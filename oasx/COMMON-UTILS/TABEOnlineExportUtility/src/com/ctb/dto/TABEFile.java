...
public class TABEFile {
	...
	private String scaleVectorResponse;
	...
	public String getScaleVectorResponse() {
		return scaleVectorResponse;
	}

	public void setScaleVectorResponse(String scaleVectorResponse) {
		this.scaleVectorResponse = scaleVectorResponse;
	}
