...
*/
  ...
  FUNCTION GETTESTSESSIONSTATUS(VCONFIGDATA TEST_SCHEDULE_CONFIG%ROWTYPE)
    RETURN VARCHAR2;
  FUNCTION GENERATEPASSWORD(DESIREDLENGTH NUMBER, ISACCESSCODE NUMBER) RETURN VARCHAR2;
  ...
  PROCEDURE PROCESSSELCREATETESTSESSION(VCUSTOMERID INTEGER,
                                     VPRODUCTID  INTEGER,
                                     SCHEDULINGTYPE VARCHAR2);
  ...
  */
                 ...
                 from (select distinct test_roster_id, cc.default_value
                        ...
                        where cc.customer_id = ' ||
                          ...
                          and cc.customer_configuration_name = ' || '''' ||
                              ...
                              ' and student_id in (' || VSTUDENTLIST || ' )
                       union
                       select distinct test_roster_id, null as default_value
                         from test_roster
                        where test_admin_id = ' ||
        ...
        FOR RECTCITEMSETID IN CRSGETTCTESTFORPRODUCT(VPRODUCTID, VCREATEDBY) LOOP
          ...
          --IF (INCLUDED_CODE) THEN
           ...
           /* BEGIN
            ...
            ELSE
             /* DBMS_OUTPUT.PUT_LINE('Inside NOT grade 6-8');*/
              ...
              IF (INCLUDED_CODE) THEN
                ...
                IF (CRSGETSTUFORALLGRADEATSCHOOL%FOUND) THEN
                  ...
                  SELECT SEQ_TEST_ADMIN_ID.NEXTVAL
                    INTO VTESTADMINID
                    FROM DUAL;
                  /*DBMS_OUTPUT.PUT_LINE('Creating test admin for Org :' ||
                                       RECSCHOOLNODE.ORG_NODE_ID);*/
  ...
  EXCEPTION
    WHEN OTHERS THEN
      ...
      ROLLBACK; -- ROLLBACK ALL DATA MODIFIED EXPLICITELY
      RAISE;
  END PROCESSSELCREATETESTSESSION;
