...
/**
 * This class represents the Data of StudentDemoGraphics Table
 * 
 * @author TCS
 * 
 */
public class StudentDemoGraphics extends CTBBean {
	...
	private StudentDemographicValue[] studentDemographicValues = null;
	private Integer id;
	...
	/**
	 * @param studentDemographicValues
	 *            the studentDemographicValues to set
	 */
	 ...
	 *            the customerDemographicId to set
	 */
	...
	/**
	 * @param importEditable
	 *            the importEditable to set
	 */
	...
	/**
	 * @param studentDemographicDataId
	 *            the studentDemographicDataId to set
	 */
