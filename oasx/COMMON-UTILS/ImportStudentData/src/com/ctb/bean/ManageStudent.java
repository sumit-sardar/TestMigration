...
/**
 * Data bean representing the partial contents of the OAS.STUDENT table and the
 * student's assigned org nodes.
 * 
 * @author TCS
 */
public class ManageStudent extends CTBBean {
	...
	/**
	 * @param studentIdNumber2
	 *            the studentIdNumber2 to set
	 */
