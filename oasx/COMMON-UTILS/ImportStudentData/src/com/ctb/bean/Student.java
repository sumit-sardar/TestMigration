...
public class Student extends CTBBean {
	...
	/**
	 * @param extendedTimeAccom
	 *            the extendedTimeAccom to set
	 */
	...
	/**
	 * @param potentialDuplicatedStudent
	 *            The potentialDuplicatedStudent to set.
	 */
