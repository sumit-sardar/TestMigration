...
public class Student {
	...
	private Set<StudentAccommodations> studentAccommodations = new HashSet<StudentAccommodations>();
	...
	/**
	 * @param extStudentId2 the extStudentId2 to set
	 */
	...
	/**
	 * @return the studentAccommodations
	 */
	public Set<StudentAccommodations> getStudentAccommodations() {
		return studentAccommodations;
	}

	/**
	 * @param studentAccommodations the studentAccommodations to set
	 */
	public void setStudentAccommodations(Set<StudentAccommodations> studentAccommodations) {
