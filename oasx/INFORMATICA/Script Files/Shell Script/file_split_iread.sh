...
DB_OAS_USER=oas_stage_ird

#Set the PASSWORD of OAS Schema                                                                #
DB_OAS_PASSWD=oas_stage_ird

#Set the DB Connection String                                                                  #
DB_CONN_STRING=@OASR51D
...
V_COMPUTER_NAME=`grep "COMPUTER_NAME" $3/oas_eiss_iread.par|sed 's/COMPUTER_NAME=//'`

# IDentifying the Version Number from the parameter file oas_eiss.par
V_VERSION_NUM=`grep "VERSION_NUM"  $3/oas_eiss_iread.par|sed 's/VERSION_NUM=//'`


# IDentifying the Build_Date from the parameter file oas_eiss.par
#V_BUILD_DATE=`grep "BUILD_DATE"  $3/oas_eiss_iread.par|sed 's/BUILD_DATE=//'`
...
#cat $1/eiss_IREAD.dat > $1/eiss_IREAD1.dat
cp $1/eiss_IREAD.dat $1/eiss_IREAD1.dat

ln=$(head -1 /$1/eiss_IREAD1.dat)
...
#cat $1/eiss_IREAD1.dat | egrep -v `cat  $1/eiss_IREAD1.dat | head -1` >> $1/$V_FILE_NAME
#echo "$ln" > $2/$V_FILE_NAME.$RUN_DATE
#cat $1/eiss_IREAD1.dat | egrep -v `cat  $1/eiss_IREAD1.dat | head -1` >> $2/$V_FILE_NAME.$RUN_DATE

#cp $1/eiss_IREAD1.dat $1/$V_FILE_NAME
sed '1 c\'"$ln"'' $1/eiss_IREAD1.dat > $1/$V_FILE_NAME
cp $1/eiss_IREAD1.dat $2/$V_FILE_NAME.$RUN_DATE
