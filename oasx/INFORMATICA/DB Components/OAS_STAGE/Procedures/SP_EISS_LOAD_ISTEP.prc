CREATE OR REPLACE PROCEDURE SP_EISS_LOAD_ISTEP IS
  ...
  CURSOR TD_REC(ID1 NUMBER, ID2 NUMBER, ID3 NUMBER, ID4 NUMBER, V_GRADE VARCHAR2, P_OPUNIT STG_EISS_TB.OPUNIT%TYPE) IS
