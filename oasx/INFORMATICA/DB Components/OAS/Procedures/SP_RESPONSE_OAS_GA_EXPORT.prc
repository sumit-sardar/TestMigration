CREATE OR REPLACE PROCEDURE SP_RESPONSE_OAS_GA_EXPORT IS
    ...
    FOR C_ST_REC IN C_ST LOOP
      ...
      LOOP
        ...
        FOR QUESTION_NO IN 1 .. V_SR_RESP_TAB.COUNT LOOP
          ...
          V_ERASURE_COUNT := V_ERASURE_COUNT +
                             erasure_count(C_ST_REC.TEST_ROSTER_ID,
