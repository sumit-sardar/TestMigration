...
/**
 * Servlet implementation class for Servlet: LTIAuthServlet
 *
 */
 public class LTIAuthServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<java.lang.String,java.lang.String[]> reqParams = (Map<java.lang.String,java.lang.String[]>)request.getParameterMap();
	       ...
	       if(oauthMap.size()>0 && baseString.length()>1)
	       {
	    	   ...
	    	   try {
				HmacSha1Signature.calculateRFC2104HMAC(signString,"key");
