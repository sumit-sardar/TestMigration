...
public class ParseFilterProperties extends Properties {
    ...
    public ParseFilterProperties() {
        loadParserFilterProperties(DEFAULT_PROP_FILE);
    }

    public ParseFilterProperties(String propFileName) {
    ...
    private void loadParserFilterProperties(String propsFileName) {
    ...
    public String getImagesBaseCanonicalPath() {
    ...
    public File getImagesBaseCanonicalFile() {
        File file = new File(getProperty(MEDIA_IMAGES_BASEPATH));
    ...
    public static ParseFilterProperties instance() {
        if (instance == null) {
