...
public class AbsolutePathOperation implements FieldOperation {
    ...
    private com.ctb.util.ParseFilterProperties pathProperties = null;
    private String basepath = null;
    private Set fileSet = new HashSet();
    public AbsolutePathOperation() {}

    public AbsolutePathOperation(String imageAreaPath) {
        this(new File(imageAreaPath));
    }

    public AbsolutePathOperation(File imageAreaPath) {
        try {
    ...
    public AbsolutePathOperation(com.ctb.util.ParseFilterProperties props) {
