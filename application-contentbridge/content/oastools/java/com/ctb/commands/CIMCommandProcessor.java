...
import com.ctb.common.tools.MappingConfig;
...
import com.ctb.cprocessor.CommandProcessorFactory;
import com.ctb.cprocessor.CommandProcessorFactoryUtil;
import com.ctb.cprocessor.CommandProcessorImportAndMapItemsContentQA;
import com.ctb.cprocessor.CommandProcessorImportAssessmentFromContentQA;
import com.ctb.cprocessor.CommandProcessorValidateItemXML;
import com.ctb.cprocessor.decorator.CommandProcessorReportingDecorator;
import com.ctb.cprocessor.decorator.HibernateCommandProcessorTransactionDecorator;
...
import com.ctb.sofa.PremadeTestHolderAssembler;
        ...
        else
        {
	       ...
	       // }
	        CommandProcessor cp = CommandProcessorFactory.newCommandProcessorImportAssessment(
	                ...
	                scoringConfig, productConfig, bSubtestMedia, unicodeList,adsConfig, maxPanelWidth, includeAcknowledgment );
