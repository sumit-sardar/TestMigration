...
import com.ctb.cprocessor.decorator.CommandProcessorHierarchyReportingDecorator;
...
public class CommandProcessorFactory {
    ...
    public static CommandProcessor newCommandProcessorImportAssessment(Connection connection,
        ...
        return CommandProcessorFactory.newCommandProcessorImportAssessment(connection, rootElement,
                objectives, itemMap, scoringConfig, productConfig, false, new ArrayList(), new ADSConfig(), new String(), new String() );
    }
    ...
    public static CommandProcessor newCommandProcessorImportAssessment(Connection connection,
        ...
        CommandProcessor cp = new CommandProcessorImportAssessment(objectives, itemMap,
                rootElement, connection, scoringConfig, productConfig, doSubtestMedia, unicodeList, adsConfig, maxpanelWidth, includeAcknowledgment);
        return cp;
    }
