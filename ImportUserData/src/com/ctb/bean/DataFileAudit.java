...
/**
 * This class represents the Data of DataFileAudit Table
 * @author TCS
 * 
 */
public class DataFileAudit extends CTBBean {
	...
	/**
	 * @param uploadFileRecordCount
	 *            the uploadFileRecordCount to set
	 */
