...
/**
 * This class represents the Data of Customer-Configuration Table with embedded
 * Customer-Configuration-value data
 * 
 * @author TCS
 * 
 */
public class CustomerConfiguration extends CTBBean {
	...
	/**
	 * @param customerConfigurationValues
	 *            the customerConfigurationValues to set
	 */
