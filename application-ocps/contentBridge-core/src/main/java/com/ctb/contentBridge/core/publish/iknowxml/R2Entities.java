...
// TODO - mws - remove this class when all XML processing is done with doc type headers
/**
 * <p>Provides a CTB specific patch to XML entity escapes.  This class is a replacement for the Entities class
 * called by org.apache.commons.lang.StringEscapeUtils.  This class should no longer be needed when doc type headers
 * are used for all XML processing</p>
 *
...
public class R2Entities {
    ...
    static final String[][] ISO8859_1_ARRAY = {
        // TODO - mws - here is the fix, move nbsp --> #160
     ...
     */
    public static final R2Entities XML;

    /**
     * <p>The set of entities supported by HTML 3.2.</p>
     */
    public static final R2Entities HTML32;

    /**
     * <p>The set of entities supported by HTML 4.0.</p>
     */
    public static final R2Entities HTML40;
    ...
    static {
        HTML32 = new R2Entities();
        HTML32.addEntities(BASIC_ARRAY);
        HTML32.addEntities(ISO8859_1_ARRAY);
    }

    static {
        HTML40 = new R2Entities();
        fillWithHtml40Entities(HTML40);
    }

    static void fillWithHtml40Entities(R2Entities entities) {
    ...
    static class BinaryEntityMap extends ArrayEntityMap {
        ...
        public void add(String name, int value) {
            ...
            System.arraycopy(names, insertAt, names, insertAt + 1,
                    size - insertAt);
            names[insertAt] = name;
            size++;
        }
