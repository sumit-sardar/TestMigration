 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class CommandProcessorImportAndMapItemsContentQA implements
		CommandProcessor {
	private final Element rootElement;
	private final Session session;

	public CommandProcessorImportAndMapItemsContentQA(Element rootElement_,
