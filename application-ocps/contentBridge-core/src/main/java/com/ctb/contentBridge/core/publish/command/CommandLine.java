...
public class CommandLine {
    ...
    public void setCommand(String asCommand) {
    ...
    public void setParameters(Map avParameters) {
        this.parameters = avParameters;
    }
    ...
    public String getFileParameterPath(String parameterName) {
        String fileName = getParameterValue(parameterName);
        File file = new File(fileName);
