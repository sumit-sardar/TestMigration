...
function cal_popup1 (str_datetime,contextUrl) {
	...
	var obj_calwindow = window.open(
		...
		'Calendar', 'width=245,height='+(this.time_comp ? 180 : 180)+
...
function cal_gen_date1 (dt_datetime) {
	...
	return (
		...
		+ strMonthArray[dt_datetime.getMonth()] + "-"
...
//	dt_date.setMonth(arr_date[1]-1);
           dt_date.setMonth(month_value[arr_date[1]]);
...
function initializeCalendar1(obj) {
		  var cal1;		  
			cal1 = new calendar2(obj);
			cal1.year_scroll = true;
			cal1.time_comp = false;			
