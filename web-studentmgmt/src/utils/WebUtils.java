...
{ 
	...
	public static String verifyABEValidStudentContact(StudentContactInformation studentContact){
		...
		String sectionName = "Contact Information";
		...
		if(invalidPrimaryPhoneLength(studentContact)){
			invalidNumFieldCount += 1;            
			invalidNumFields = buildErrorString(Message.FIELD_PRIMARY_PHONE, invalidNumFieldCount, invalidNumFields);       
		
		}
		if(invalidSecondaryPhoneLength(studentContact)){
			invalidNumFieldCount += 1;            
			invalidNumFields = buildErrorString(Message.FIELD_SECONDARY_PHONE, invalidNumFieldCount, invalidNumFields);       
		}
