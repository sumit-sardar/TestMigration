...
<netui:html>
  <head>
    <netui:base/>
    <title>OAS Widgets - <netui-template:attribute name="title"/></title>
  ...
  <body>
    ...
    <tr>
        ...
        <td id="legacyBody">
            ...
            <a style="float:right;" target="viewSourceJsp"  href="<%=request.getContextPath()%>/viewSourceJsp<%=request.getServletPath()%>"><img src="<%=request.getContextPath()%>/resources/images/viewsource.png" alt="view the source" border="0" title="view the source" /></a>
