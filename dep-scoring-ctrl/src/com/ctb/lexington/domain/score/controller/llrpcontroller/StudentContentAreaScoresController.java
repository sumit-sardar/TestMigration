...
public class StudentContentAreaScoresController {
    ...
    private IrsLLRPContentAreaFactMapper mapper;
    ...
    public StudentContentAreaScoresController(Connection conn, StudentSubtestScoresData subtestData, StsTestResultFactData factData, CurriculumData currData, StudentTestData testData, AdminData adminData, ContextData context) {
        ...
        mapper = new IrsLLRPContentAreaFactMapper(conn);
    }

    public void run() throws SQLException {
        IrsLLRPContentAreaFactData [] facts = getContentAreaFactBeans();
        for(int i=0;i<facts.length;i++) {
        	IrsLLRPContentAreaFactData newFact = facts[i];
    ...
    public IrsLLRPContentAreaFactData [] getContentAreaFactBeans() {
        ...
        ArrayList facts = new ArrayList();
            for(int i=0;i<contentAreas.length;i++) {
               ...
               if(fact != null &&
                   ...
                   IrsLLRPContentAreaFactData newFact = new IrsLLRPContentAreaFactData();
        ...
        return (IrsLLRPContentAreaFactData []) facts.toArray(new IrsLLRPContentAreaFactData[0]);
    }
}
