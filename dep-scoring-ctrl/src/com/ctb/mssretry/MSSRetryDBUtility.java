...
//	private static final ResourceBundle rb = ResourceBundle.getBundle("config"); Comment Out TASC FT TE Items Scoring for Story OAS-3944
	private static final String SP_FETCH_MSS_ERRORS = "{call sp_fetch_mss_retry_errors(?,?)}";
//	public static int retryReqRowCount = Integer.parseInt(rb.getString("ftte.retry.fetchsize")); Comment Out TASC FT TE Items Scoring for Story OAS-3944
	public static int retryReqRowCount = 20;
