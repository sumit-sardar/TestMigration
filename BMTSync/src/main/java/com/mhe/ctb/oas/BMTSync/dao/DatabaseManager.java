...
public class DatabaseManager {
	...
	private static InitialContext context = null;  // used to lookup database connection
	...
	public DatabaseManager() {
		...
		try {
			...
			datasource = (DataSource) context.lookup("EHSDATASOURCE");
		} catch (Exception e) {
			e.printStackTrace();
		}
		*/
	...
	protected static Connection dbConnectionJDNI() {
