...
public class TMSServlet extends HttpServlet {
	...
	private String feedback(String xml) throws XmlException, IOException, ClassNotFoundException {
        ...
        for(int i=0;i<feedback.length;i++) {
            ...
            feedbackResponse.getTitle().getScoArray()[i].setTitle(feedback[i].getProduct() + "::" + feedback[i].getTestTitle() + "::" + feedback[i].getTitle() + "::" + feedback[i].getForm() + "::" + feedback[i].getLevel() + "::" + feedback[i].getScoOrder());
