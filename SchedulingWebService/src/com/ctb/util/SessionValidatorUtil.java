...
public class SessionValidatorUtil {
	...
	public static final String MESSAGE_UPDATE_ACCOMODATION_AT_SESSION = "Warning:One or more students have started this assessment. The changes you have made to the accommodations will be visible to students who begin this test <i>after</i> this change is saved.";
