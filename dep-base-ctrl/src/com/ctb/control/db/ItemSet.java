...
{ 
    ...
    */
    ...
    @JdbcControl.SQL(statement ="SELECT DECODE(COUNT(1), 0, 'false', 'true') FROM ITEM_DATAPOINT_SCORE WHERE TEST_ROSTER_ID = {testRosterId}")
    String checkExtHandScoring(Integer testRosterId) throws SQLException; 
