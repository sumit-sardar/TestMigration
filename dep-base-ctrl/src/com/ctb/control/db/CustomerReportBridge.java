...
{ 
     ...
     *     and bridge.product_id = program.product_id // COMMENTING THIS LINE FOR LAS A/B/C CUSTOMER ON 01 JULY,2013
     *     and bridge.product_id = case when (bridge.product_id=4000 or bridge.product_id=4200) then program.product_id else bridge.product_id end //ADDED TO DEAL WITH LAS A/B/C CUSTOMER and TABE/TESTLET CUSTOMER
