...
public interface CRScoring extends JdbcControl {
	...
	*/
	...
	//get response for AI item
	 ...
	 Clob getCRItemResponses(Integer testRosterId, Integer deliverableItemId, String itemId);
